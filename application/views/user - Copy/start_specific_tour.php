...
<script type="text/javascript">
    ...
    if(tour_session)
    {
      if(tour_session == "specific_tour")
      {
        ...
        var tour_session = localStorage.getItem('tour_start');
        var res = tour_session.split("-");
        var currentTab = res[1];

        var my_tour = new Tour(steps,currentTab);
        my_tour.show();
