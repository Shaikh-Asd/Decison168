                ...
                <ol class="breadcrumb m-0">
                    ...
                    <form name="portfolio_projects_content_search" id="portfolio_projects_content_search" method="post">
                            <div class="form-group mb-2">
                                    <input type="hidden" name="port_id" value="<?php echo $this->session->userdata('searched_content_port_id');?>">
                                    <!-- <label>Search</label> -->
                                    <select class="form-select" name="pid_contentplan" id="pid_contentplan" onchange="return portfolio_projects_content_search_submit();" style="width: 180px !important;">
                                        ...
                                        if($contentPlanningPublishDate)
                                        {
                                            ...
                                            {
                                        ?>
                                        <option value="<?php echo $cpdl->publish_date;?>" <?php if($this->session->userdata('searched_content_date') == $cpdl->publish_date){ echo "selected";}?> ><?php echo $cpdl->publish_date;?></option>
                                        <?php
                                            }
                                        }
                                        ?>
                                    ...
                                    <a class="float-end nameLink" style="font-weight: 300 !important;font-size: 12px;" href="<?php echo base_url('portfolio-projects-content/'.$this->session->userdata('searched_content_port_id'));?>">Clear Filter</a>
                            </div>
                    </form>
                    <?php
                        }
...
if($contentPlanningDetails)
{
    ...
    {
        $getContentPlanningByDel = $this->Front_model->getContentPlanningByDel2($cpd->pc_project_assign,$this->session->userdata('searched_content_date'));
                    ...
                    <table class="table table-nowrap align-middle mb-0">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Platform : Publish Date</th>
            ...
            foreach($contentPlanningDetails as $cpd)
            {
                ...
                if($getContentPlanningByDel){
                    ...
                    foreach ($getContentPlanningByDel as $cp) {
                        ...
                        if($cp->platform == 'twitter')
                        {
                            echo '<div class="product-color-item rounded"><i class="fab fa-twitter font-size-24 social-d" title="Twitter"></i></div><p class="p-1"><span class="badge badge-soft-dark">'.$cp->publish_date.'</span></p>';
                        }else if($cp->platform == 'facebook')
                        {
                            echo '<div class="product-color-item rounded"><i class="fab fa-facebook font-size-24 social-d" title="Facebook"></i></div><p class="p-1"><span class="badge badge-soft-dark">'.$cp->publish_date.'</span></p>';
                        }else if($cp->platform == 'instagram')
                        {
                            echo '<div class="product-color-item rounded"><i class="fab fa-instagram font-size-24 social-d" title="Instagram"></i></div><p class="p-1"><span class="badge badge-soft-dark">'.$cp->publish_date.'</span></p>';
                        }else if($cp->platform == 'linkedin')
                        {
                            echo '<div class="product-color-item rounded"><i class="fab fa-linkedin font-size-24 social-d" title="LinkedIn"></i></div><p class="p-1"><span class="badge badge-soft-dark">'.$cp->publish_date.'</span></p>';
                        }else if($cp->platform == 'google-my-business')
                        {
                            echo '<div class="product-color-item rounded"><i class="mdi mdi-google-my-business font-size-24 social-d" title="Google My Business"></i></div><p class="p-1"><span class="badge badge-soft-dark">'.$cp->publish_date.'</span></p>';
                        }else if($cp->platform == 'pinterest')
                        {
                            echo '<div class="product-color-item rounded"><i class="fab fa-pinterest font-size-24 social-d" title="Pinterest"></i></div><p class="p-1"><span class="badge badge-soft-dark">'.$cp->publish_date.'</span></p>';
                        }else if($cp->platform == 'youtube')
                        {
                            echo '<div class="product-color-item rounded"><i class="fab fa-youtube font-size-24 social-d" title="YouTube"></i></div><p class="p-1"><span class="badge badge-soft-dark">'.$cp->publish_date.'</span></p>';
                        }else if($cp->platform == 'blogger')
                        {
                            echo '<div class="product-color-item rounded"><i class="fab fa-blogger font-size-24 social-d" title="Blog"></i></div><p class="p-1"><span class="badge badge-soft-dark">'.$cp->publish_date.'</span></p>';
                        }else if($cp->platform == 'tiktok')
                        {
                            echo '<div class="product-color-item rounded"><i class="fab fa-tiktok font-size-24 social-d" title="TikTok"></i></div><p class="p-1"><span class="badge badge-soft-dark">'.$cp->publish_date.'</span></p>';
                        }else{
                            echo $cp->platform;
                        }
                        ?></a><?php
