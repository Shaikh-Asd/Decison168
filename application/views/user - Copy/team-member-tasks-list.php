...
<div class="row p-3 progressbar_display">
    <div class="col pt-1 pb-3" style="background: #ffffff">
        <?php 
        $progress_done = $this->Front_model->progress_done3($pid,$tassignee);
        $progress_total = $this->Front_model->progress_total3($pid,$tassignee);
        $sub_progress_done = $this->Front_model->sub_progress_done3($pid,$tassignee);
        $sub_progress_total = $this->Front_model->sub_progress_total3($pid,$tassignee);
