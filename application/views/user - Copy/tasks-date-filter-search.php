                                        ...
                                        <div class="input-group mb-3">
                                            <form name="task_date_filter" id="task_date_filter" method="post" autocomplete="off">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-1">
                                                        <a class="btn btn-sm bg-d text-white" style="font-weight: 300 !important;font-size: 12px;" href="<?php echo base_url('portfolio-tasks-list/'.$port_id);?>">Clear</a>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
...
if($AssignedSubtasklist_Task)
{
    ...
    if($check_tid != $get_atl->tid)
    {
        ...
        if($atl)
        {
            if(($atl->tassignee != $this->session->userdata('d168_id')) || (($atl->tassignee == $this->session->userdata('d168_id')) && ($atl->tdue_date != $tf_end_date) && ($atl->tdue_date > $tf_end_date)))
            {
            $check_pro_createdby = "";
            if(!empty($atl->tproject_assign))
            {
...
?> 
        ...
        if(($atl->tproject_assign != '0') && ($check_pro_member_status_grid != 'accepted') && ($check_pro_createdby_grid != $this->session->userdata('d168_id')))
        {
            $check_suggested = $this->Front_model->check_project_suggested_member($atl->tproject_assign);
        ?>
        <section ng-repeat="new_card in new_cards" class="new_card theme-orange search-cards parent_task all-data <?php echo $atl->tstatus.'_class';?>" data-color="#52A43A" data-searchid="<?php echo $atl->tdue_date;?>">
        ...
        {
        ?>
        <section ng-repeat="new_card in new_cards" class="new_card theme-orange search-cards parent_task all-data <?php echo $atl->tstatus.'_class';?>" data-color="#52A43A" data-id="<?php echo $atl->tid;?>" data-class="task_class" data-searchid="<?php echo $atl->tdue_date;?>">
          <section class="new_card__part new_card__part-2">
            <div class="new_card__part__side m--back m--back--c">
              <div class="new_card__part__inner new_card__face">
                <div class="new_card__face__colored-side"></div>
        ...
        ?>
        <section ng-repeat="new_card in new_cards" class="new_card theme-orange search-cards parent_task all-data <?php echo $atl->ststatus.'_class';?>" data-color="#52A43A" data-searchid="<?php echo $atl->stdue_date;?>">
          <section class="new_card__part new_card__part-2">
            <div class="new_card__part__side m--back m--back--c">
              <div class="new_card__part__inner new_card__face">
                <div class="new_card__face__colored-side"></div>
        ...
        {
                                                    ?>
        <section ng-repeat="new_card in new_cards" class="new_card theme-orange search-cards parent_task all-data <?php echo $atl->ststatus.'_class';?>" data-color="#52A43A" data-id="<?php echo $atl->stid;?>" data-class="subtask_class" data-searchid="<?php echo $atl->stdue_date;?>">
          <section class="new_card__part new_card__part-2">
            <div class="new_card__part__side m--back m--back--c">
              <div class="new_card__part__inner new_card__face">
                <div class="new_card__face__colored-side"></div>
        ...
        if(($atl->tproject_assign != '0') && ($check_pro_member_status_grid != 'accepted') && ($check_pro_createdby_grid != $this->session->userdata('d168_id')))
        {
            $check_suggested = $this->Front_model->check_project_suggested_member($atl->tproject_assign);
        ?>
        <section ng-repeat="new_card in new_cards" class="new_card theme-green search-cards parent_task all-data <?php echo $atl->tstatus.'_class';?>" data-color="#52A43A" data-searchid="<?php echo $atl->tdue_date;?>">
          <section class="new_card__part new_card__part-2">
            <div class="new_card__part__side m--back m--back--c">
              <div class="new_card__part__inner new_card__face">
                <div class="new_card__face__colored-side"></div>
        ...
        {
                                                        ?>
        <section ng-repeat="new_card in new_cards" class="new_card theme-green search-cards parent_task all-data <?php echo $atl->tstatus.'_class';?>" data-color="#52A43A" data-id="<?php echo $atl->tid;?>" data-class="task_class" data-searchid="<?php echo $atl->tdue_date;?>">
          <section class="new_card__part new_card__part-2">
            <div class="new_card__part__side m--back m--back--c">
              <div class="new_card__part__inner new_card__face">
                <div class="new_card__face__colored-side"></div>
        ...
        if(($atl->stproject_assign != '0') && ($check_pro_member_status_grid != 'accepted') && ($check_pro_createdby_grid != $this->session->userdata('d168_id')))
        {
            $check_suggested = $this->Front_model->check_project_suggested_member($atl->stproject_assign);
        ?>
        <section ng-repeat="new_card in new_cards" class="new_card theme-green search-cards parent_task all-data <?php echo $atl->ststatus.'_class';?>" data-color="#52A43A" data-searchid="<?php echo $atl->stdue_date;?>">
          <section class="new_card__part new_card__part-2">
            <div class="new_card__part__side m--back m--back--c">
              <div class="new_card__part__inner new_card__face">
                <div class="new_card__face__colored-side"></div>
        ...
        {
                                                        ?>
        <section ng-repeat="new_card in new_cards" class="new_card theme-green search-cards parent_task all-data <?php echo $atl->ststatus.'_class';?>" data-color="#52A43A" data-id="<?php echo $atl->stid;?>" data-class="subtask_class" data-searchid="<?php echo $atl->stdue_date;?>">
          <section class="new_card__part new_card__part-2">
            <div class="new_card__part__side m--back m--back--c">
              <div class="new_card__part__inner new_card__face">
                <div class="new_card__face__colored-side"></div>
        ...
        if(($atl->tproject_assign != '0') && ($check_pro_member_status_grid != 'accepted') && ($check_pro_createdby_grid != $this->session->userdata('d168_id')))
        {
            $check_suggested = $this->Front_model->check_project_suggested_member($atl->tproject_assign);
        ?>
        <section ng-repeat="new_card in new_cards" class="new_card theme-red search-cards parent_task all-data <?php echo $atl->tstatus.'_class';?>" data-color="#52A43A" data-searchid="<?php echo $atl->tdue_date;?>">
          <section class="new_card__part new_card__part-2">
            <div class="new_card__part__side m--back m--back--c">
              <div class="new_card__part__inner new_card__face">
                <div class="new_card__face__colored-side"></div>
        ...
        {
                                                        ?>
        <section ng-repeat="new_card in new_cards" class="new_card theme-red search-cards parent_task all-data <?php echo $atl->tstatus.'_class';?>" data-color="#52A43A" data-id="<?php echo $atl->tid;?>" data-class="task_class" data-searchid="<?php echo $atl->tdue_date;?>">
          <section class="new_card__part new_card__part-2">
            <div class="new_card__part__side m--back m--back--c">
              <div class="new_card__part__inner new_card__face">
                <div class="new_card__face__colored-side"></div>
        ...
        if(($atl->stproject_assign != '0') && ($check_pro_member_status_grid != 'accepted') && ($check_pro_createdby_grid != $this->session->userdata('d168_id')))
        {
            $check_suggested = $this->Front_model->check_project_suggested_member($atl->stproject_assign);
        ?>
        <section ng-repeat="new_card in new_cards" class="new_card theme-red search-cards parent_task all-data <?php echo $atl->ststatus.'_class';?>" data-color="#52A43A" data-searchid="<?php echo $atl->stdue_date;?>">
          <section class="new_card__part new_card__part-2">
            <div class="new_card__part__side m--back m--back--c">
              <div class="new_card__part__inner new_card__face">
                <div class="new_card__face__colored-side"></div>
        ...
        {
                                                        ?>
        <section ng-repeat="new_card in new_cards" class="new_card theme-red search-cards parent_task  all-data <?php echo $atl->ststatus.'_class';?>" data-color="#52A43A" data-id="<?php echo $atl->stid;?>" data-class="subtask_class" data-searchid="<?php echo $atl->stdue_date;?>">
          <section class="new_card__part new_card__part-2">
            <div class="new_card__part__side m--back m--back--c">
              <div class="new_card__part__inner new_card__face">
                <div class="new_card__face__colored-side"></div>
