...
<head>
        ...
        <meta charset="utf-8" />
<title><?php echo ucfirst($sname);?> History</title>
...
?>
                    <div class="row">
                        <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-5"><?php echo $sname;?> History
                                        ...
                                        <ul class="verti-timeline list-unstyled">
                                            ...
                                            <li class="event-list active" style="padding-bottom: 25px;">
                                                ...
                                                <div class="media">
                                                    <div class="me-3">
                                                        <h5 class="font-size-14 card-title"><a href="javascript:void(0)" onclick="return display_hlist_strategy('<?php echo $sid;?>','<?php echo $v->DateOnly;?>');" class="text-dark"><?php echo 'Today - '.date("D, F d, Y", strtotime($v->DateOnly));?></a></h5>
                                                    </div>
                                                </div>
                                            </li>
                                            <?php
                                            ...
                                            <li class="event-list active" style="padding-bottom: 25px;">
                                                ...
                                                <div class="media">
                                                    <div class="me-3">
                                                        <h5 class="font-size-14 card-title"><a href="javascript:void(0)" onclick="return display_hlist_strategy('<?php echo $sid;?>','<?php echo $v->DateOnly;?>');" class="text-dark"><?php echo 'Yesterday - '.date("D, F d, Y", strtotime($v->DateOnly));?></a></h5>
                                                    </div>
                                                </div>
                                            </li>
                                            <?php
                                            ...
                                            <li class="event-list active" style="padding-bottom: 25px;">
                                                ...
                                                <div class="media">
                                                    <div class="me-3">
                                                        <h5 class="font-size-14 card-title"><a href="javascript:void(0)" onclick="return display_hlist_strategy('<?php echo $sid;?>','<?php echo $v->DateOnly;?>');" class="text-dark"><?php echo date("D, F d, Y", strtotime($v->DateOnly));?></a></h5>
                                                    </div>
                                                </div>
                                            </li>
                                            <?php
...
<div class="modal fade" id="excel_date_options" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form method="post" id="strategy_history_excel_form" name="strategy_history_excel_form" autocomplete="off">
