                    ...
                    <div class="auth-full-page-content p-md-5 p-4">
                        <div class="w-100">
                            ...
                            <div class="d-flex flex-column h-100">
                                <div class="mb-4 mb-md-5" style="padding: 0 20%;">
                                ...
                                <div class="my-auto">
                                    ...
                                    <div>
                                        <h5 class="text-d"> Reset Password</h5>
                                        <p class="text-white">Reset-Password with Decision 168.</p>
                                    </div>
                                    ...
                                    <div class="mt-4">
                                            ...
                                            ?>
                                        <div class="alert alert-warning text-center mb-4" id="hide_msg" role="alert">
                                            Enter your Email and instructions will be sent to you!
                                        </div>
                                        <div class="alert alert-danger" role="alert" id="reg_in_message" style="display: none;">
                                            <i class="mdi mdi-block-helper me-2"></i>
                                        </div>
                                        <form method="POST" name="reset_form" id="reset_form" class="login_form" autocomplete="off">
                                            ...
                                            <div class="form-group">
                                              ...
                                              <div class="text-end">
                                                <button class="btn btn-d btn-sm w-md waves-effect waves-light" type="submit">Reset</button>
                                            </div>
                                        </form> 
                                ...
                                <div class="mt-4 mt-md-5 text-white text-center">
