<?php
   ...
   if(!$port_detail)
   {
     header("Location:" . base_url().'portfolio-view');
   }
   ?>
<!doctype html>
<html lang="en">
            ...
            $count_cp = $this->Front_model->count_Portfolio_project($getp->portfolio_id);
               ...
               $count_ccp = $this->Front_model->count_portfolio_project_content($getp->portfolio_id);
                ...
                $count_ct = $this->Front_model->count_Portfolio_task($getp->portfolio_id);
                   ...
                   $count_gl = $this->Front_model->count_goals($getp->portfolio_id);
                       if($count_gl)
                       {
                         $goal = $count_gl['count_rows'];
                       }
                       $count_active = $this->Front_model->get_active_port_report($getp->portfolio_id);
                          if($count_active)
                          {
                              $active = $count_active['count_rows'];
                          }
            
                $count_inactive = $this->Front_model->get_inactive_port_report($getp->portfolio_id);
                    if($count_inactive)
                    {
...
?>
                                             ...
                                             <div class="docs-options">
                                                ...
                                                <div class="input-group mb-3">
                                                   <div class="text-center">
                                                      ...
                                                      <label class="form-check-label">Team Performance</label>
                                                   </div>
                                                </div>
                                             </div>
                                          </div>
                  ...
                  <div class="row">
                     <div class="col-xl-6" id="port_hide">
                        <div class="card">
                           <div class="card-body">
                              ...
                              <div id="donut-chart-portfolio" dir=""></div>
                     ...
                     <div class="col-xl-6" id="mem_hide">
                        <div class="card">
                           <div class="card-body">
                              ...
                              <div id="doughnut" class="e-charts" style="height: 262px; !important"></div>
                              <!-- <canvas id="doughnut" style="width: 800px;height: 800px;"></canvas> -->
                           </div>
                        </div>
                     </div>
                     <!-- end col -->
                     ...
                     <div class="col-xl-12" id="ind_hide">
                        <div class="card">
                           <div class="card-body">
                              <div class="row">
                                 <div class="col-xl-6">
                                    <h4 class="card-title mb-4">Individual Member</h4>
                                 </div>
                                 <div class="col-xl-6">
                  ...
                  <!-- end row -->
                  <div class="row">
                     <div class="col-xl-6" id="dept_hide">
                        <div class="card">
                           <div class="card-body">
                              <div class="row">
                                 <div class="col-xl-6">
                                 ...
                                 <div class="col-xl-6">
                                    <select class="form-control " name="" id="selected_depart"  required="">
                                       <?php
                                          $get_dpt = $this->Front_model->get_PortfolioDepartment($getp->portfolio_id);
                                           if($get_dpt){
      ...
      <div class="modal fade" id="loaderModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
         <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content" style="border-top: 5px solid #f7f7f6 !important;">
               <div class="modal-body">
                  <img src="../assets/images/page-load-loader.gif" alt="loader" class="loadingif" style="margin-left: 260px; height:300px;">
                  <br>   
                                 ...
                                 <table class="table align-middle table-nowrap table-hover">
                                    ...
                                    <tbody>
                                       ...
                                       <tr>
                                          ...
                                          <td>
                                             <div class="text-center">
                                                <a href="javascript: void(0);" class="nameLink" onclick="return previewModalFile(<?php echo $template->id;?>)" title="Preview"><i class="bx bx-search-alt h3 m-1 text-d"></i></a>
                                                <a href="<?php echo base_url().'front/download_report/'.$template->id;?>" class="text-dark" title="Download"><i class="bx bx-download h3 m-1 text-d"></i></a>
                                                <a href="javascript:void(0)" onclick="return delete_report(<?php echo $template->id ?>);" class="text-dark" title="Delete"><i class="bx bxs-x-square h3 m-1"></i></a>
                                             </div>
                                          </td>
                                       </tr>
                                       <?php
                     ...
                     <div class="col-xl-10">
                        <div class="card-body" id="checkForm">
                           ...
                           <div class="row">
                              <div class="col-md-1">
                                 <div class="form-check form-switch">
                                    <input style="font-size: 20px!important;" class="form-check-input checkbox checkbox_new" name="progress"  type="checkbox" id="portfolio_member" value="portfolio_member">
                                 </div>
                              </div>
                              <div class="col-md-6">
...
?>
      ...
      <div id="previewModalFile" class="modal fade bs-example-modal-lg" tabindex="-1" aria-labelledby="#previewModalFileLabel" aria-hidden="true">
         <div class="modal-dialog modal-lg">
            <div class="modal-content" id="previewModalFile_content">
            </div>
            <!-- /.modal-content -->
         </div>
         <!-- /.modal-dialog -->
      ...
      <script src="<?php echo base_url();?>assets/js/portfolio_report.js"></script>
