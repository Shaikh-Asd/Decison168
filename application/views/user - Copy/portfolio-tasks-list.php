                                    ...
                                    <div class="docs-options">
                                        <div class="input-group mb-3">
                                            <div class="text-center">
                                               <input class="form-check-input" type="radio" name="myTask_radio" id="myTask_radio" value="all" checked>
                                               <label class="form-check-label">All</label>
                                            </div>
                                        </div>
                                        <div class="input-group mb-3">
                                            <div class="text-center">
                                               <input class="form-check-input" type="radio" name="myTask_radio" id="myTask_radio" value="today">
                            ...
                            <div class="col-xl">
                                <div class="mt-4 mt-xl-0">
                                    <div class="docs-options">
                                        <div class="input-group mb-3">
                                            <div class="text-center">
                                               <input class="form-check-input" type="radio" name="myTask_radio" id="myTask_radio" value="tomorrow">
                                               <label class="form-check-label">Tomorrow</label>
                                            </div>
                                        </div>
                                        <div class="input-group mb-3">
                                            <div class="text-center">
                                               <input class="form-check-input" type="radio" name="myTask_radio" id="myTask_radio" value="this_week">
                            ...
                            <div class="col-xl">
                                <div class="mt-4 mt-xl-0">
                                    <div class="docs-options"> 
                                        <div class="input-group mb-3">
                                            <div class="text-center">
                                               <input class="form-check-input" type="radio" name="myTask_radio" id="myTask_radio" value="week">
                                               <label class="form-check-label">Next 168</label>
                                            </div>
                                        </div>
                                        <div class="input-group mb-3">
                                            <div class="text-center">
                                               <input class="form-check-input" type="radio" name="myTask_radio" id="myTask_radio" value="overdue">
                                            ...
                                            <form name="task_date_filter" id="task_date_filter" method="post" autocomplete="off">
                                                <div class="row">
                                                    <div class="col-10">
                                                        ...
                                                        <input type="hidden" name="date_filter_page_name" value="my_assigned">
...
?>
                        ...
                        <div class="row">
                            ...
                            <span class="timerSBtn_<?php echo $l_subtask->stid;?>">
                                ...
                                <input type="hidden" value="<?php echo $l_subtask->stid?>" id="timer_sflag_<?php echo $l_subtask->stid?>">
