                ...
                <div class="row d-none d-sm-block">
                    <div class="col-12">
                        <ul class="nav nav-pills justify-content-end">
                            ...
                            <li class="nav-item me-3">
                                <div class="text-center">
                                   <input class="form-check-input" type="radio" name="trash_radio" id="goal_trash" onclick="return trash_filter();">
                                   <label class="form-check-label">Goals</label>
                                </div>
                            </li>
                            <li class="nav-item me-3">
                                <div class="text-center">
                                   <input class="form-check-input" type="radio" name="trash_radio" id="strategy_trash" onclick="return trash_filter();">
                    ...
                    <div class="col-6">
                        <div class="btn-group me-1 mt-2">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="javascript: void(0);"><input class="form-check-input" type="radio" name="trash_radio2" id="all_trash2" onclick="return all_trash_filter2();" checked>
                                   <label class="form-check-label">All</label></a>
                                <a class="dropdown-item" href="javascript: void(0);"><input class="form-check-input" type="radio" name="trash_radio2" id="goal_trash2" onclick="return trash_filter2();">
                                   <label class="form-check-label">Goals</label></a>
                                <a class="dropdown-item" href="javascript: void(0);"><input class="form-check-input" type="radio" name="trash_radio2" id="strategy_trash2" onclick="return trash_filter2();">
                                   <label class="form-check-label">KPIs</label></a>
                                <a class="dropdown-item" href="javascript: void(0);"><input class="form-check-input" type="radio" name="trash_radio2" id="project_trash2" onclick="return trash_filter2();">
                                   <label class="form-check-label">Projects</label></a>
                                <a class="dropdown-item" href="javascript: void(0);"><input class="form-check-input" type="radio" name="trash_radio2" id="task_trash2" onclick="return trash_filter2();">
                                   <label class="form-check-label">Tasks & Subtasks</label></a>
                                <a class="dropdown-item" href="javascript: void(0);"><input class="form-check-input" type="radio" name="trash_radio2" id="file_trash2" onclick="return trash_filter2();">
                                   <label class="form-check-label">Files</label></a>
                                <a class="dropdown-item" href="javascript: void(0);"><input class="form-check-input" type="radio" name="trash_radio2" id="platform_trash2" onclick="return trash_filter2();">
...
{
?>
<a href="javascript:void(0)" onclick="return pfile_retrieve('<?php echo $l->pfile_id;?>');" class="btn btn-d btn-sm" id="retrieve_link<?php echo $l->pfile_id;?>">Restore</a> <?php 
                                                                        }
                                                                        ?>
                                                                            </td>
                                                                            <td>
...
{
?>
<a href="javascript:void(0)" onclick="return pfile_del_forever('<?php echo $l->pfile_id;?>');" class="btn bg-d btn-sm text-white" id="pfdel_link<?php echo $l->pfile_id;?>">Delete</a> <?php 
                                                                        }
                                                                        ?>
                                                                            </td>
                                                                        </tr>
...
{
?>
<a href="javascript:void(0)" onclick="return tfile_retrieve('<?php echo $l2->tid;?>','<?php echo $l2->tfile;?>','<?php echo $l2->trash_id;?>');" class="btn btn-d btn-sm" id="retrieve_link<?php echo $l2->trash_id;?>">Restore</a> <?php 
                                                                        }
                                                                        ?>
                                                                            </td>
                                                                            <td>
...
{
?>
<a href="javascript:void(0)" onclick="return tfile_del_forever('<?php echo $l2->tid;?>','<?php echo $l2->trash_id;?>');" class="btn bg-d btn-sm text-white" id="tfdel_link<?php echo $l2->trash_id;?>">Delete</a> <?php 
                                                                        }
                                                                        ?>
                                                                            </td>
                                                                        </tr>
...
{
?>
<a href="javascript:void(0)" onclick="return project_retrieve('<?php echo $l4->pid;?>');" class="btn btn-d btn-sm" id="retrieve_link<?php echo $l4->pid;?>">Restore</a> <?php 
                                                                        }
                                                                        ?>
                                                                    </td>
                                                                    <td>
...
{
?>
<a href="javascript:void(0)" onclick="return project_del_forever('<?php echo $l4->pid;?>');" class="btn bg-d btn-sm text-white" id="pdel_link<?php echo $l4->pid;?>">Delete</a> <?php 
                                                                        }
                                                                        ?>
                                                                    </td>
                                                                </tr>
...
{
?>
<a href="javascript:void(0)" onclick="return task_retrieve('<?php echo $l5->tid;?>');" class="btn btn-d btn-sm" id="retrieve_link<?php echo $l5->tid;?>">Restore</a> <?php 
                                                                        }
                                                                        ?>
                                                                    </td>
                                                                    <td>
...
{
?>
<a href="javascript:void(0)" onclick="return task_del_forever('<?php echo $l5->tid;?>');" class="btn bg-d btn-sm text-white" id="tdel_link<?php echo $l5->tid;?>">Delete</a> <?php 
                                                                        }
                                                                        ?>
                                                                    </td>
                                                                </tr>
...
{
?>
<a href="javascript:void(0)" onclick="return stfile_retrieve('<?php echo $l6->stid;?>','<?php echo $l6->stfile;?>','<?php echo $l6->strash_id;?>');" class="btn btn-d btn-sm" id="retrieve_link<?php echo $l6->strash_id;?>">Restore</a> <?php 
                                                                        }
                                                                        ?>
                                                                            </td>
                                                                            <td>
...
{
?>
<a href="javascript:void(0)" onclick="return stfile_del_forever('<?php echo $l6->stid;?>','<?php echo $l6->strash_id;?>');" class="btn bg-d btn-sm text-white" id="stfdel_link<?php echo $l6->strash_id;?>">Delete</a> <?php 
                                                                        }
                                                                        ?>
                                                                            </td>
                                                                        </tr>
...
{
?>
<a href="javascript:void(0)" onclick="return subtask_retrieve('<?php echo $l7->stid;?>');" class="btn btn-d btn-sm" id="sretrieve_link<?php echo $l7->stid;?>">Restore</a> <?php 
                                                                        }
                                                                        ?>
                                                                    </td>
                                                                    <td>
...
{
?>
<a href="javascript:void(0)" onclick="return subtask_del_forever('<?php echo $l7->stid;?>');" class="btn bg-d btn-sm text-white" id="sdel_link<?php echo $l7->stid;?>">Delete</a> <?php 
                                                                        }
                                                                        ?>
                                                                    </td>
                                                                </tr>
...
{
?>
<a href="javascript:void(0)" onclick="return platform_retrieve('<?php echo $l8->pc_id;?>');" class="btn btn-d btn-sm" id="cpretrieve_link<?php echo $l8->pc_id;?>">Restore</a> <?php 
                                                                        }
                                                                        ?>
                                                                    </td>
                                                                    <td>
...
{
?>
<a href="javascript:void(0)" onclick="return platform_del_forever('<?php echo $l8->pc_id;?>');" class="btn bg-d btn-sm text-white" id="pldel_link<?php echo $l8->pc_id;?>">Delete</a> <?php 
                                                                        }
                                                                        ?>
                                                                    </td>
                                                                </tr>
                                                        ...
                                                        if($TrashGoals)
                                                        {
                                                            foreach($TrashGoals as $l9)
                                                            {
                                                                $getp = $this->Front_model->file_itgetPortfolio2($l9->portfolio_id);
                                                                ?>
                                                                <tr>
                                                                    <td><?php if($getp){ if($getp->portfolio_user == 'company'){ echo $getp->portfolio_name;}elseif($getp->portfolio_user == 'individual'){ echo $getp->portfolio_name.' '.$getp->portfolio_mname.' '.$getp->portfolio_lname;}else{ echo $getp->portfolio_name;}}?></td>
                                                                    <td><?php echo $l9->gname;?></td>
                                                                    <td></td>
                                                                    <td>Goal</td>
                                                                    <td><?php echo $l9->g_trash_date;?></td>
                                                                    <td>
                                                                        <?php
if($privilege_only_view == 'no')
{
?>
<a href="javascript:void(0)" onclick="return goal_retrieve('<?php echo $l9->gid;?>');" class="btn btn-d btn-sm" id="retrieve_glink<?php echo $l9->gid;?>">Restore</a> <?php 
                                                                        }
                                                                        ?>
                                                                    </td>
                                                                    <td>
...
{
?>
<a href="javascript:void(0)" onclick="return goal_del_forever('<?php echo $l9->gid;?>');" class="btn bg-d btn-sm text-white" id="gdel_glink<?php echo $l9->gid;?>">Delete</a> <?php 
                                                                        }
                                                                        ?>
                                                                    </td>
                                                                </tr>
                                                        ...
                                                        if($TrashStrategies)
                                                        {
                                                            foreach($TrashStrategies as $l10)
                                                            {
                                                                $getp = $this->Front_model->file_itgetPortfolio2($l10->portfolio_id);
                                                                ?>
                                                                <tr>
                                                                    <td><?php if($getp){ if($getp->portfolio_user == 'company'){ echo $getp->portfolio_name;}elseif($getp->portfolio_user == 'individual'){ echo $getp->portfolio_name.' '.$getp->portfolio_mname.' '.$getp->portfolio_lname;}else{ echo $getp->portfolio_name;}}?></td>
                                                                    <td><?php echo $l10->sname;?></td>
                                                                    <td></td>
                                                                    <td>KPI</td>
                                                                    <td><?php echo $l10->s_trash_date;?></td>
                                                                    <td>
                                                                        <?php
if($privilege_only_view == 'no')
{
?>
<a href="javascript:void(0)" onclick="return strategy_retrieve('<?php echo $l10->sid;?>');" class="btn btn-d btn-sm" id="retrieve_gslink<?php echo $l10->sid;?>">Restore</a> <?php 
                                                                        }
                                                                        ?>
                                                                    </td>
                                                                    <td>
...
{
?>
<a href="javascript:void(0)" onclick="return strategy_del_forever('<?php echo $l10->sid;?>');" class="btn bg-d btn-sm text-white" id="sdel_gslink<?php echo $l10->sid;?>">Delete</a> <?php 
                                                                        }
                                                                        ?>
                                                                    </td>
                                                                </tr>
                        ...
                        <div class="row" id="goal_trash_list" style="display:none;">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="text-danger">( If you do not restore deleted data within 30 days, then data will be deleted permanently ! )</h5>
                                        <div class="table-responsive">
                                            <div id="mask"></div>
                                            <table id="datatable13" class="table table-nowrap align-middle mb-0">
                                                <thead class="table-light">
                                                    <tr>
                                                        <th scope="col">Portfolio</th>
...
<a href="javascript:void(0)" onclick="return goal_del_forever('<?php echo $l9->gid;?>');" class="btn bg-d btn-sm text-white" id="gdel_glink<?php echo $l9->gid;?>">Delete</a> <?php 
                        ...
                        <div class="row" id="strategy_trash_list" style="display:none;">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="text-danger">( If you do not restore deleted data within 30 days, then data will be deleted permanently ! )</h5>
                                        <div class="table-responsive">
                                            <div id="mask"></div>
                                            <table id="datatable14" class="table table-nowrap align-middle mb-0">
                                                <thead class="table-light">
                                                    <tr>
                                                        <th scope="col">Portfolio</th>
                                                        <th scope="col">KPI</th>
            ...
            setTimeout(function () {
                ...
                var template = '<div class="modalFilter">' +
                                 ...
                                 '<div class="modal-footer">' +
                                     '<a href="#!" onclick="clearFilter(this, {1}, \'{2}\');"  class=" btn bg-d btn-sm text-white text-white">Clear</a>' +
