                ...
                <ol class="breadcrumb m-0">
                    ...
                    <form name="all_project_search_task" id="all_project_search_task" method="post">
                            <div class="form-group mb-2">
                                    <input type="hidden" name="page_name" value="all_tasks_page">
                                    <!-- <label>Search</label> -->
                                    ...
                                    {
                                    ?>
                                    <a class="float-end nameLink" style="font-weight: 300 !important;font-size: 12px;" href="<?php echo base_url('all-tasks');?>">Clear Filter</a> 
                                    <?php
                                    }
                                    ?>
                            </div>
