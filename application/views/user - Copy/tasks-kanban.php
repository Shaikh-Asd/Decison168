...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">Task Kanban</h4>

            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);">Task Kanban</a></li>
                </ol>
            </div>
                                            ...
                                            <div id="upcoming-task" class="pb-1 task-list">
                                                        ...
                                                        <div class="avatar-group float-start task-assigne">
                                                            <div class="avatar-group-item">
                                                                <a href="javascript: void(0);" class="d-inline-block" value="member-4">
                                                                    <img src="<?php echo base_url();?>assets/images/users/avatar-4.jpg" alt="" class="rounded-circle avatar-xs">
                                                                </a>
                                                            </div>
                                                            <div class="avatar-group-item">
                                                                <a href="javascript: void(0);" class="d-inline-block" value="member-5">
                                                                    <img src="<?php echo base_url();?>assets/images/users/avatar-5.jpg" alt="" class="rounded-circle avatar-xs">
                                                                </a>
                                                            </div>
                                                            <div class="avatar-group-item">
                                                                <a href="javascript: void(0);" class="d-inline-block" value="member-6">
                                                                    <img src="<?php echo base_url();?>assets/images/users/avatar-2.jpg" alt="" class="rounded-circle avatar-xs">
                                                                </a>
                                                            </div>
                                                            <div class="avatar-group-item">
                                                        ...
                                                        <div class="avatar-group float-start task-assigne">
                                                            <div class="avatar-group-item">
                                                                <a href="javascript: void(0);" class="d-inline-block" value="member-1">
                                                                    <img src="<?php echo base_url();?>assets/images/users/avatar-1.jpg" alt="" class="rounded-circle avatar-xs">
                                                                </a>
                                                            </div>
                                                            <div class="avatar-group-item">
                                                ...
                                                <div class="card task-box" id="uptask-3">
                                                    <div class="card-body">
                                                        ...
                                                        <div>
                                                            <h5 class="font-size-15"><a href="javascript: void(0);" class="text-dark" id="task-name">Create a Decision168 Logo</a></h5>
                                            ...
                                            <div id="inprogress-task" class="pb-1 task-list">
                                                        ...
                                                        <ul class="list-inine ps-0 mb-4">
                                                                ...
                                                                <a href="#">
                                                                    <div class="border rounded avatar-sm">
                                                                        <span class="avatar-title bg-transparent">
                                                                            <img src="<?php echo base_url();?>assets/images/companies/img-1.png" alt="" class="avatar-xs">
                                                                        </span>
                                                                    </div>
                                                                </a>
                                                            </li>
                                                            <li class="list-inline-item">
                                                                <a href="#">
                                                                    <div class="border rounded avatar-sm">
                                                                        <span class="avatar-title bg-transparent">
                                                                            <img src="<?php echo base_url();?>assets/images/companies/img-2.png" alt="" class="avatar-xs">
                                                                        </span>
                                                                    </div>
                                                                </a>
                                                            </li>
                                                            <li class="list-inline-item">
                                                                <a href="#">
                                                                    <div class="border rounded avatar-sm">
                                                                        <span class="avatar-title bg-transparent">
                                                                            <img src="<?php echo base_url();?>assets/images/companies/img-3.png" alt="" class="avatar-xs">
                                                                        </span>
                                                                    </div>
                                                                </a>
                                                            </li>
                                                        ...
                                                        <div class="avatar-group float-start task-assigne">
                                                            <div class="avatar-group-item">
                                                                <a href="javascript: void(0);" class="d-inline-block" value="member-7">
                                                                    <img src="<?php echo base_url();?>assets/images/users/avatar-7.jpg" alt="" class="rounded-circle avatar-xs">
                                                                </a>
                                                            </div>
                                                            <div class="avatar-group-item">
                                                                <a href="javascript: void(0);" class="d-inline-block" value="member-8">
                                                                    <img src="<?php echo base_url();?>assets/images/users/avatar-8.jpg" alt="" class="rounded-circle avatar-xs">
                                                                </a>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="card task-box" id="intask-2">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="avatar-group float-start task-assigne">
                                                            <div class="avatar-group-item">
                                                                <a href="javascript: void(0);" class="d-inline-block" value="member-6">
                                                                    <img src="<?php echo base_url();?>assets/images/users/avatar-6.jpg" alt="" class="rounded-circle avatar-xs">
                                                                </a>
                                                            </div>
                                                            <div class="avatar-group-item">
                                                                <a href="javascript: void(0);" class="d-inline-block" value="member-4">
                                                ...
                                                <div class="card task-box" id="intask-3">
                                                    <div class="card-body">
                                                        ...
                                                        <div>
                                                            <h5 class="font-size-15"><a href="javascript: void(0);" class="text-dark" id="task-name">Decision168 Dashboard UI</a></h5>
                                                            <p class="text-muted mb-4">13 Oct, 2019</p>
                                                        </div>
                                            ...
                                            <div id="complete-task" class="pb-1 task-list">
                                                        ...
                                                        <div class="avatar-group float-start task-assigne">
                                                            ...
                                                            <div class="avatar-group-item">
                                                                <a href="javascript: void(0);" class="d-inline-block" value="member-3">
                                                                    <img src="<?php echo base_url();?>assets/images/users/avatar-3.jpg" alt="" class="rounded-circle avatar-xs">
                                                                </a>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <ul class="list-inline mb-4">
                                                            <li class="list-inline-item">
                                                                <a href="#">
                                                                    <div>
                                                                        <img src="<?php echo base_url();?>assets/images/small/img-4.jpg" class="rounded" alt="" height="48">
                                                                    </div>
                                                                </a>
                                                            </li>
                                                            <li class="list-inline-item">
                                                                <a href="#">
                                                                    <div>
                                                                        <img src="<?php echo base_url();?>assets/images/small/img-5.jpg" class="rounded" alt="" height="48">
                                                                    </div>
                                                                </a>
                                                            </li>
                                                            <li class="list-inline-item">
                                                                <a href="#">
                                                                    <div>
                                                                        <img src="<?php echo base_url();?>assets/images/small/img-6.jpg" class="rounded" alt="" height="48">
                                                                    </div>
                                                                </a>
                                                            </li>
                                                        </ul>
                                                ...
                                                <div class="card task-box" id="cmptask-3">
                                                    <div class="card-body">
                                                        ...
                                                        <div>
                                                            <h5 class="font-size-15"><a href="javascript: void(0);" class="text-dark" id="task-name">Decision168 landing Psd</a></h5>
                                                            <p class="text-muted mb-4">15 Oct, 2019</p>
                                                        </div>
                                        ...
                                        <ul class="list-unstyled user-list validate" id="taskassignee">
                                            <li>
                                                <div class="form-check form-check-primary mb-2 d-flex align-items-center">
                                                    ...
                                                    <img src="<?php echo base_url();?>assets/images/users/avatar-1.jpg" class="rounded-circle avatar-xs m-1" alt="">
                                                </div>
                                            </li>
                                            <li>
                                                <div class="form-check form-check-primary mb-2 d-flex align-items-center">
                                                    ...
                                                    <img src="<?php echo base_url();?>assets/images/users/avatar-2.jpg" class="rounded-circle avatar-xs m-1" alt="">
                                                </div>
                                            </li>
                                            <li>
                                                <div class="form-check form-check-primary mb-2 d-flex align-items-center">
                                                    ...
                                                    <img src="<?php echo base_url();?>assets/images/users/avatar-3.jpg" class="rounded-circle avatar-xs m-1" alt="">
                                                </div>
                                            </li>
                                            <li>
                                                <div class="form-check form-check-primary mb-2 d-flex align-items-center">
                                                    ...
                                                    <img src="<?php echo base_url();?>assets/images/users/avatar-4.jpg" class="rounded-circle avatar-xs m-1" alt="">
                                                </div>
                                            </li>
                                            <li>
                                                <div class="form-check form-check-primary mb-2 d-flex align-items-center">
                                                    ...
                                                    <img src="<?php echo base_url();?>assets/images/users/avatar-5.jpg" class="rounded-circle avatar-xs m-1" alt="">
                                                </div>
                                            </li>
                                            <li>
                                                <div class="form-check form-check-primary mb-2 d-flex align-items-center">
                                                    ...
                                                    <img src="<?php echo base_url();?>assets/images/users/avatar-6.jpg" class="rounded-circle avatar-xs m-1" alt="">
                                                </div>
                                            </li>
                                            <li>
                                                <div class="form-check form-check-primary mb-2 d-flex align-items-center">
                                                    ...
                                                    <img src="<?php echo base_url();?>assets/images/users/avatar-7.jpg" class="rounded-circle avatar-xs m-1" alt="">
                                                </div>
                                            </li>
                                            <li>
                                                <div class="form-check form-check-primary mb-2 d-flex align-items-center">
                                                    ...
                                                    <img src="<?php echo base_url();?>assets/images/users/avatar-8.jpg" class="rounded-circle avatar-xs m-1" alt="">
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
...
<script src="<?php echo base_url();?>assets/libs/node-waves/waves.min.js"></script>
        ...
        <script src="<?php echo base_url();?>assets/js/pages/task-form.init.js"></script>
