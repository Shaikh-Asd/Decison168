...
.description .description-edit input:focus-visible {
  ...
  background: #F3F3F4;
    ...
    <body onload="return GetTask_Filter();" data-sidebar="dark">
        <!-- Begin page -->
...
<!-- ========== Left Sidebar Start ========== -->
            ...
            $check_active_portfolio = $this->Front_model->check_PortfolioMemberActive($port_id, $ActiveEmail_ID);
                        ...
                        <ul class="nav nav-pills justify-content-end">
                            ...
                            <li class="nav-item me-3 mt-2">
                                <div class="text-center">
                                   <input class="form-check-input" type="radio" name="myTask_radio" id="myTask_radio" value="all" <?php if(!empty($getFilter)){ if($getFilter == "all"){ echo "checked";}}?>>
                                   <label class="form-check-label">All</label>
                                </div>
                            </li>
                            <li class="nav-item me-3 mt-2">
                                <div class="text-center">
                                   <input class="form-check-input" type="radio" name="myTask_radio" id="myTask_radio" value="today" <?php if(!empty($getFilter)){ if($getFilter == "today"){ echo "checked";}}?>>
                                   <label class="form-check-label">Today</label>
                                </div>
                            </li>
                            <li class="nav-item me-3 mt-2">
                                <div class="text-center">
                                   <input class="form-check-input" type="radio" name="myTask_radio" id="myTask_radio" value="tomorrow" <?php if(!empty($getFilter)){ if($getFilter == "tomorrow"){ echo "checked";}}?>>
                                   <label class="form-check-label">Tomorrow</label>
                                </div>
                            </li>
                            <li class="nav-item me-3 mt-2">
                                <div class="text-center">
                                   <input class="form-check-input" type="radio" name="myTask_radio" id="myTask_radio" value="week" <?php if(!empty($getFilter)){ if($getFilter == "week"){ echo "checked";}}?>>
                                   <label class="form-check-label">This Week</label>
                                </div>
                            </li>
                            <li class="nav-item me-3 mt-2">
                                <div class="text-center">
                                   <input class="form-check-input" type="radio" name="myTask_radio" id="myTask_radio" value="overdue" <?php if(!empty($getFilter)){ if($getFilter == "overdue"){ echo "checked";}}?>>
                            ...
                            <li class="nav-item">
                                ...
                                if($plist || $accepted_plist)
                                    {
                                ?>
                                <form name="project_search_task" id="project_search_task" method="post">
                                        <div class="form-group mb-2">
                                                ...
                                                <select class="form-select" name="pid_task" id="pid_task" onchange="return project_search_task_submit();" style="width: 180px !important;">
                                                    <?php
                                                    if($plist)
                                                    {
                                                        foreach($plist as $pl)
                                                    ...
                                                    if($accepted_plist)
                                                    {
                                                        foreach($accepted_plist as $apl)
                                                        {
                                                            $t_avail2 = "";
                                                            $st_avail2 = "";
                                                            $check_t_avail2 = $this->Front_model->check_t_avail($apl->pid);
                                                            if($check_t_avail2 > 0)
                                                            {
                                                                $t_avail2 = "yes";
                                                            }
                                                            $check_st_avail2 = $this->Front_model->check_st_avail($apl->pid);
                                                ...
                                                <a class="float-end nameLink" style="font-weight: 300 !important;font-size: 12px;" href="<?php echo base_url('portfolio-tasks-list/'.$port_id);?>">Clear Filter</a>   
                                        </div>
                                </form>
                                <?php
                                    }
...
if($AssignedTasklist)
{
    foreach($AssignedTasklist as $atl)
    {
        $check_pro_createdby = "";
...
if($AssignedSubtasklist_Task)
{
    $check_tid = "";
    foreach($AssignedSubtasklist_Task as $get_atl)
    {
...
<div class="row">
    ...
    <div class="col-lg-2 col-md-3 col-sm-3 col-xs-4">
        ...
        if(($atl->tproject_assign != '0') && ($check_pro_member_status_grid != 'accepted') && ($check_pro_createdby_grid != $this->session->userdata('d168_id')))
        {
            $check_suggested = $this->Front_model->check_project_suggested_member($atl->tproject_assign);
        ?>
        <section ng-repeat="new_card in new_cards" class="new_card theme-orange search-cards parent_task all-data <?php if(($atl->tdue_date < date('Y-m-d')) && ($atl->tstatus != 'done')){ echo "overdue_task_in_list";}else{ echo "future_task_in_list";}?> <?php echo $atl->tstatus.'_class';?>" data-color="#52A43A" data-searchid="<?php echo $atl->tdue_date;?>">
        ...
        {
        ?>
        <section ng-repeat="new_card in new_cards" class="new_card theme-orange search-cards parent_task all-data <?php if(($atl->tdue_date < date('Y-m-d')) && ($atl->tstatus != 'done')){ echo "overdue_task_in_list";}else{ echo "future_task_in_list";}?> <?php echo $atl->tstatus.'_class';?>" data-color="#52A43A" data-id="<?php echo $atl->tid;?>" data-class="task_class" data-searchid="<?php echo $atl->tdue_date;?>">
          <section class="new_card__part new_card__part-2">
            <div class="new_card__part__side m--back m--back--c">
              <div class="new_card__part__inner new_card__face">
                <div class="new_card__face__colored-side"></div>
                ...
                <div class="new_card__face__from-to">
                 <p class="ng-binding">
                    <i class="fas fa-pencil-alt text-d new_cursor_editable" onclick="showEditTnameModal(<?php echo $atl->tid; ?>);"></i>
            ...
            ?>
                ...
                <div class="new_card__face__deliv-date ng-binding">
                  Due<i class="fas fa-calendar-alt text-d ms-1 new_cursor_editable" onclick="showEditTduedateModal(<?php echo $atl->tid; ?>);"></i>
        ...
        <!-- end ngRepeat: new_card in new_cards -->
                                                    ...
                                                    if($AssignedSubtasklist)
                                                    {
                                                        foreach($AssignedSubtasklist as $atl)
                                                        {
        ...
        ?>
        <section ng-repeat="new_card in new_cards" class="new_card theme-orange search-cards parent_task all-data <?php if(($atl->stdue_date < date('Y-m-d')) && ($atl->ststatus != 'done')){ echo "overdue_task_in_list";}else{ echo "future_task_in_list";}?> <?php echo $atl->ststatus.'_class';?>" data-color="#52A43A" data-searchid="<?php echo $atl->stdue_date;?>">
          <section class="new_card__part new_card__part-2">
            <div class="new_card__part__side m--back m--back--c">
              <div class="new_card__part__inner new_card__face">
                <div class="new_card__face__colored-side"></div>
        ...
        {
                                                    ?>
        <section ng-repeat="new_card in new_cards" class="new_card theme-orange search-cards parent_task all-data <?php if(($atl->stdue_date < date('Y-m-d')) && ($atl->ststatus != 'done')){ echo "overdue_task_in_list";}else{ echo "future_task_in_list";}?> <?php echo $atl->ststatus.'_class';?>" data-color="#52A43A" data-id="<?php echo $atl->stid;?>" data-class="subtask_class" data-searchid="<?php echo $atl->stdue_date;?>">
          <section class="new_card__part new_card__part-2">
            <div class="new_card__part__side m--back m--back--c">
              <div class="new_card__part__inner new_card__face">
                <div class="new_card__face__colored-side"></div>
                ...
                <div class="new_card__face__from-to">
                  <p class="ng-binding">
                    <i class="fas fa-pencil-alt text-d new_cursor_editable" onclick="showEditSTnameModal(<?php echo $atl->stid; ?>);"></i>
                ...
                <div class="new_card__face__deliv-date ng-binding">
                  Due<i class="fas fa-calendar-alt text-d ms-1 new_cursor_editable" onclick="showEditSTduedateModal(<?php echo $atl->stid; ?>);"></i>
        ...
        if(($atl->tproject_assign != '0') && ($check_pro_member_status_grid != 'accepted') && ($check_pro_createdby_grid != $this->session->userdata('d168_id')))
        {
            $check_suggested = $this->Front_model->check_project_suggested_member($atl->tproject_assign);
        ?>
        <section ng-repeat="new_card in new_cards" class="new_card theme-green search-cards parent_task all-data <?php if(($atl->tdue_date < date('Y-m-d')) && ($atl->tstatus != 'done')){ echo "overdue_task_in_list";}else{ echo "future_task_in_list";}?> <?php echo $atl->tstatus.'_class';?>" data-color="#52A43A" data-searchid="<?php echo $atl->tdue_date;?>">
          <section class="new_card__part new_card__part-2">
            <div class="new_card__part__side m--back m--back--c">
              <div class="new_card__part__inner new_card__face">
                <div class="new_card__face__colored-side"></div>
        ...
        {
                                                        ?>
        <section ng-repeat="new_card in new_cards" class="new_card theme-green search-cards parent_task all-data <?php if(($atl->tdue_date < date('Y-m-d')) && ($atl->tstatus != 'done')){ echo "overdue_task_in_list";}else{ echo "future_task_in_list";}?> <?php echo $atl->tstatus.'_class';?>" data-color="#52A43A" data-id="<?php echo $atl->tid;?>" data-class="task_class" data-searchid="<?php echo $atl->tdue_date;?>">
          <section class="new_card__part new_card__part-2">
            <div class="new_card__part__side m--back m--back--c">
              <div class="new_card__part__inner new_card__face">
                <div class="new_card__face__colored-side"></div>
        ...
        if(($atl->stproject_assign != '0') && ($check_pro_member_status_grid != 'accepted') && ($check_pro_createdby_grid != $this->session->userdata('d168_id')))
        {
            $check_suggested = $this->Front_model->check_project_suggested_member($atl->stproject_assign);
        ?>
        <section ng-repeat="new_card in new_cards" class="new_card theme-green search-cards parent_task all-data <?php if(($atl->stdue_date < date('Y-m-d')) && ($atl->ststatus != 'done')){ echo "overdue_task_in_list";}else{ echo "future_task_in_list";}?> <?php echo $atl->ststatus.'_class';?>" data-color="#52A43A" data-searchid="<?php echo $atl->stdue_date;?>">
          <section class="new_card__part new_card__part-2">
            <div class="new_card__part__side m--back m--back--c">
              <div class="new_card__part__inner new_card__face">
                <div class="new_card__face__colored-side"></div>
        ...
        {
                                                        ?>
        <section ng-repeat="new_card in new_cards" class="new_card theme-green search-cards parent_task all-data <?php if(($atl->stdue_date < date('Y-m-d')) && ($atl->ststatus != 'done')){ echo "overdue_task_in_list";}else{ echo "future_task_in_list";}?> <?php echo $atl->ststatus.'_class';?>" data-color="#52A43A" data-id="<?php echo $atl->stid;?>" data-class="subtask_class" data-searchid="<?php echo $atl->stdue_date;?>">
          <section class="new_card__part new_card__part-2">
            <div class="new_card__part__side m--back m--back--c">
              <div class="new_card__part__inner new_card__face">
                <div class="new_card__face__colored-side"></div>
        ...
        if(($atl->tproject_assign != '0') && ($check_pro_member_status_grid != 'accepted') && ($check_pro_createdby_grid != $this->session->userdata('d168_id')))
        {
            $check_suggested = $this->Front_model->check_project_suggested_member($atl->tproject_assign);
        ?>
        <section ng-repeat="new_card in new_cards" class="new_card theme-red search-cards parent_task all-data <?php if(($atl->tdue_date < date('Y-m-d')) && ($atl->tstatus != 'done')){ echo "overdue_task_in_list";}else{ echo "future_task_in_list";}?> <?php echo $atl->tstatus.'_class';?>" data-color="#52A43A" data-searchid="<?php echo $atl->tdue_date;?>">
          <section class="new_card__part new_card__part-2">
            <div class="new_card__part__side m--back m--back--c">
              <div class="new_card__part__inner new_card__face">
                <div class="new_card__face__colored-side"></div>
        ...
        {
                                                        ?>
        <section ng-repeat="new_card in new_cards" class="new_card theme-red search-cards parent_task all-data <?php if(($atl->tdue_date < date('Y-m-d')) && ($atl->tstatus != 'done')){ echo "overdue_task_in_list";}else{ echo "future_task_in_list";}?> <?php echo $atl->tstatus.'_class';?>" data-color="#52A43A" data-id="<?php echo $atl->tid;?>" data-class="task_class" data-searchid="<?php echo $atl->tdue_date;?>">
          <section class="new_card__part new_card__part-2">
            <div class="new_card__part__side m--back m--back--c">
              <div class="new_card__part__inner new_card__face">
                <div class="new_card__face__colored-side"></div>
        ...
        if(($atl->stproject_assign != '0') && ($check_pro_member_status_grid != 'accepted') && ($check_pro_createdby_grid != $this->session->userdata('d168_id')))
        {
            $check_suggested = $this->Front_model->check_project_suggested_member($atl->stproject_assign);
        ?>
        <section ng-repeat="new_card in new_cards" class="new_card theme-red search-cards parent_task all-data <?php if(($atl->stdue_date < date('Y-m-d')) && ($atl->ststatus != 'done')){ echo "overdue_task_in_list";}else{ echo "future_task_in_list";}?> <?php echo $atl->ststatus.'_class';?>" data-color="#52A43A" data-searchid="<?php echo $atl->stdue_date;?>">
          <section class="new_card__part new_card__part-2">
            <div class="new_card__part__side m--back m--back--c">
              <div class="new_card__part__inner new_card__face">
                <div class="new_card__face__colored-side"></div>
        ...
        {
                                                        ?>
        <section ng-repeat="new_card in new_cards" class="new_card theme-red search-cards parent_task all-data <?php if(($atl->stdue_date < date('Y-m-d')) && ($atl->ststatus != 'done')){ echo "overdue_task_in_list";}else{ echo "future_task_in_list";}?> <?php echo $atl->ststatus.'_class';?>" data-color="#52A43A" data-id="<?php echo $atl->stid;?>" data-class="subtask_class" data-searchid="<?php echo $atl->stdue_date;?>">
          <section class="new_card__part new_card__part-2">
            <div class="new_card__part__side m--back m--back--c">
              <div class="new_card__part__inner new_card__face">
                <div class="new_card__face__colored-side"></div>
