                                        ...
                                        <ul class="nav nav-tabs" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" data-bs-toggle="tab" href="#all_task" role="tab">
                                                    ...
                                                    <span class="d-none d-sm-block">Tomorrow Task</span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                    ...
                                    elseif($portfolio->portfolio_user == 'individual')
                                        ...
                                        { 
                                            ...
                                            echo strtoupper($profile_name);
                                                                ...
                                                                if($TomorrowSubtasks)
                                                                {
                                                                    foreach($TomorrowSubtasks as $atl)
                                                                    {
                                                                ?>
                                                ...
                                                <p class="mb-0">
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table table-nowrap align-middle mb-0"> 
                                                            <tbody>
                                                                <?php
                                                                if($TomorrowTasksTrashlist)
                                                                {
                                                                    foreach($TomorrowTasksTrashlist as $ttl)
                                                                    { 
                                                                ?>
                                                                <tr>
                                                                    <td style="width: 45px;">
                                    ...
                                    elseif($portfolio->portfolio_user == 'individual')
                                        ...
                                        { 
                                            ...
                                            echo strtoupper($profile_name);
                                                                ...
                                                                if($TomorrowSubtasksTrashlist)
                                                                {
                                                                    foreach($TomorrowSubtasksTrashlist as $ttl)
                                                                    { 
                                                                ?>
                                                                <tr style="background-color: aliceblue;">
                                                                    <td style="width: 45px;">
