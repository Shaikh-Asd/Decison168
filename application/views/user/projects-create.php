...
?> 
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-2">Create New Project</h4>
                                        <form method="post" name="create_project_form" id="create_project_form" enctype="multipart/form-data" autocomplete="off">
                                            ...
                                            <input type="hidden" name="ptype" value="goal_strategy">
                                            <?php
                                            }
                                            else
                                            {
                                            ...
                                            ?>
                                            <div class="row mb-2">
                                                <label for="pname" class="col-form-label col-lg-2">Project Name <span class="text-danger">*</span></label>
                                                <div class="col-lg-10">
                                                    <input id="pname" name="pname" type="text" class="form-control" placeholder="Enter Project Name..." required="">
                                                    <span id="pnameErr" class="text-danger"></span>
                                                </div>
                                            </div>
                                            <div class="row mb-2">
                                                <label for="pdes" class="col-form-label col-lg-2">Project Description</label>
                                                <div class="col-lg-10">
                                                    <textarea class="form-control" id="pdes" name="pdes" rows="3" placeholder="Enter Project Description..."></textarea>
                                                </div>
                                            </div>
                                            <?php
                                        ...
                                        <div class="row mb-2">
                                            <label class="col-form-label col-lg-2">Project Link(s) & Comment(s)</label>
                                            <div class="col-lg-4">
                                        ...
                                        <div class="row justify-content-end">
                                            <div class="col-lg-10">
                                                <button type="submit" id="create_project_button" class="btn btn-d btn-sm">Create Project</button>
...
?>
    <script type="text/javascript">
        ...
        if(tour_session)
        {
          if(tour_session == "projects-create")
          {
            localStorage.setItem('tour_session', 'no');
            var steps = [ 
                {
                    title: "DECISION 168",
                    content: "<p class='popover-content'>Here you can create your project</p>"
                }, 
                {
                    title: "Project: Name",
                    id: "pname",
                    content: "<p class='popover-content'>Enter Project Name</p>"
                }, 
                {
                    title: "Project: Description",
                    id: "pdes",
                    content: "<p class='popover-content'>Enter Project Description</p>"
                },
                {
                    title: "Project: Department",
                    id: "select2-dept-container",
                    content: "<p class='popover-content'>Select Department for the Project</p>"
                },
                {
                    title: "Project: Portfolio",
                    id: "select2-portfolio_id-container",
                    content: "<p class='popover-content'>Select Portfolio for the Project</p>"
                },
                {
                ...
                },
                {
                    ...
                    content: "<p class='popover-content'>Add Team Members for the Project</p>"
                },
                {
                    title: "Project: Links",
                    id: "plink",
                    content: "<p class='popover-content'>Enter links related to the Project</p>"
                },
                {
                    title: "Project: Comment",
                    id: "plink_comment",
                    content: "<p class='popover-content'>Enter Comment related to the Project Link</p>"
                },
                {
                    title: "Project: File Upload",
                    id: "pfile",
                    content: "<p class='popover-content'>Upload Files related to the Project</p>"
                },
                {
                    title: "Project: Submit",
                    id: "create_project_button",
                    content: "<p class='popover-content'>Click here to Create Project</p>"
                }
            ];
