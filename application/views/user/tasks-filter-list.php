                    ...
                    <div>
                        <ul class="nav nav-pills justify-content-end">
                            <li class="nav-item me-2">
                                <a class="btn btn-sm bg-d text-white" href="<?php echo base_url('tasks-list');?>">
                                    ...
                                    <div class="docs-actions">
                                        <div class="input-group mb-3">
                                            <form name="task_date_filter" id="task_date_filter" method="post" autocomplete="off">
                                                ...
                                                <input type="hidden" name="date_filter_page_name" value="my_created">
                                                <div class="row">
                                                    <div class="col-5"></div>
                                                    <div class="col-5">
                                                    ...
                                                    <div class="col-1">
                                                        <a class="btn btn-sm bg-d text-white" style="font-weight: 300 !important;font-size: 12px;" href="<?php echo base_url('tasks-list');?>">Clear</a>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
...
if($CreatedTaskList)
{
    ...
    {
        // $Check_if_Task_L_Subtasks = $this->Front_model->Check_Task_Subtasks2($atl->tid);
        // if(empty($Check_if_Task_L_Subtasks))
        // {
        $check_pro_createdby = "";
