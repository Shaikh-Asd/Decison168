                                           ...
                                           <div class="avatar-sm me-2">
                                            ...
                                            <div class="media-body overflow-hidden">
                                                <div class="row task-dates">
                                                    ...
                                                    <div class="col-3">
                                                            <a href="<?php echo base_url('goal-request2/'.$gid.'/'.$gmid.'/'.'1');?>" class="btn btn-sm btn-d waves-effect waves-light float-end">
                                                                 Accept Request
                                                            </a>
                                                    </div>    
                                                    <div class="col-4">
                                                           <a href="<?php echo base_url('goal-request2/'.$gid.'/'.$gmid.'/'.'2');?>" class="btn btn-sm bg-d text-white waves-effect waves-light">
                                                                 Request More Info
                                                            </a>
                                                    </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table align-middle table-nowrap" style="margin-bottom: 0rem;">
                                                <tbody>
                                                    ...
                                                    ?>
                                                    <tr>
                                                        <th colspan="3">Project Manager : <a href="javascript:void(0)" onclick="return TeamProfileModal(<?php echo $gdetail->gmanager;?>)" class="text-dark" title="View Profile"><?php echo $gmanager_det->first_name.' '.$gmanager_det->last_name;?></a></th>
                                                    </tr>
                                                    <?php
                                                        }
                                                    } 
