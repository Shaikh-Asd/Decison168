                    ...
                    <div>
                        <ul class="nav nav-pills justify-content-end">
                            <li class="nav-item me-2">
                                <a class="btn btn-sm bg-d text-white" href="<?php echo base_url('project-tasks-list/'.$pid);?>">
                                    ...
                                    <div class="docs-actions">
                                        <div class="input-group mb-3">
                                            <form name="task_date_filter" id="task_date_filter" method="post" autocomplete="off">
                                                ...
                                                <input type="hidden" name="date_filter_page_name" value="project_tasks">
                                                <div class="row">
                                                    <div class="col-5"></div>
                                                    <div class="col-5">
                                                    ...
                                                    <div class="col-1">
                                                        <a class="btn btn-sm bg-d text-white" style="font-weight: 300 !important;font-size: 12px;" href="<?php echo base_url('project-tasks-list/'.$pid);?>">Clear</a>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
...
<div class="row p-3">
    <div class="col pt-1 pb-3" style="background: #ffffff">
        <?php 
        $progress_done = $this->Front_model->progress_done_date_range($pid,$tf_start_date,$tf_end_date);
        $progress_total = $this->Front_model->progress_total_date_range($pid,$tf_start_date,$tf_end_date);
        $sub_progress_done = $this->Front_model->sub_progress_done_date_range($pid,$tf_start_date,$tf_end_date);
        $sub_progress_total = $this->Front_model->sub_progress_total_date_range($pid,$tf_start_date,$tf_end_date);
...
?>
                                  <div class="description-details">
                                    <p><a href="javascript: void(0);" class="nameLink description-content"><?php echo $l_subtask->stname;?></a></p>
                                  </div>
<?php  
}
?>
