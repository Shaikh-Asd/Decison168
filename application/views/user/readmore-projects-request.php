<?php
$page = 'readmore-projects-request';
?>
<!doctype html>
<html lang="en">
...
<head>
        ...
        <meta charset="utf-8" />
<title>More Projects Request</title>
        ...
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);">Readmore Projects Request</a></li>
                </ol>
            </div>
...
?> 
                        ...
                        <div class="row">
                            ...
                            <div class="card card-body">
                                <h4 class="card-title">More Projects Request</h4>
            ...
            <div class="new_card__part__side m--back">
              <div class="new_card__part__inner new_card__face">
                ...
                <div class="new_card__face__deliv-date ng-binding">                  
                  <p class="ng-binding">
                                                        <a href="javascript: void(0);" class="nameLink float-end h4 eye_preview" onclick="return ProjectOverviewRequestModal(<?php echo $rp->pid;?>)" title="Preview Project"><i class="mdi mdi-eye-outline"></i></a></p>
                </div>
