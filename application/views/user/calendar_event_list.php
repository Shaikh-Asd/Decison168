...
<div id="refresh_tasklist_status_change">
    ...
    <div class="col-lg-12">
        <div class="card" style="margin-bottom: 0px;">
            ...
            <div class="row mb-2">
                <div class="col-lg-2">
                    <div class="text-center" style="font-weight: 900;">Event</div>
                </div>
                <div class="col-lg-2">
...
<?php
if($getAll_NextEvents)
{
    foreach($getAll_NextEvents as $atl)
    {
?>
...
if($getAll_PrevEvents)
{
    foreach($getAll_PrevEvents as $atl)
    {
?>
<div class="row mb-2 search-list parent_task all-data" data-searchid="<?php echo $atl->event_start_date;?>" data-end-searchid="<?php echo $atl->event_end_date;?>">   
    <div class="col-lg-12">
