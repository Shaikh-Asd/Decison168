                            ...
                            <div class="d-flex flex-column h-100">
                                ...
                                <div class="my-auto">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-white">Get your free Decision168 account now.</p>
                                    </div>
                                        ...
                                        <div class="row">
                                          ...
                                          <div class="col-12 text-center">
                                            <div class="mt-2 d-grid">
                                                <button class="btn btn-d btn-sm waves-effect waves-light" type="submit" id="register_button">Register</button>
                                                <img id="loader2" style="visibility: hidden;padding: 0px 100px !important;" src="<?php echo base_url()?>assets/images/loading.gif">
                                            </div>

                                            <div class="mt-4 text-center">
                                                <h5 class="font-size-14 mb-3 text-white">Sign up using</h5>
