                                                        ...
                                                        if($Portfolio)
                                                        {
                                                            foreach($Portfolio as $c)
                                                            {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <h5 class="font-size-14 mb-1"><?php if($c->portfolio_user == 'company'){ echo $c->portfolio_name;}elseif($c->portfolio_user == 'individual'){ echo $c->portfolio_name.' '.$c->portfolio_lname;}else{ echo $c->portfolio_name;}?></h5>
                                                                    </td>
                                                                    <td>
