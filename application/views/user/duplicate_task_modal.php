...
<script>
    // FOR  Duplicate task FORM ----------------------------------------
  $('#duplicate_task_form').on('submit',function(event){
    //debugger;
    event.preventDefault(); // Stop page from refreshing
    $('#duplicate_task_button').hide();
    $('#loader2').css('visibility','visible');
   var formData = new FormData(this); 
    $.ajax({
         url:base_url+'front/duplicate_task',
         type:"POST",
         data:formData,
         contentType:false,
         processData:false,
