...
<html lang="en">
  ...
  <body>
    ...
    if($stud_del){
      $user_name = ucwords($stud_del->first_name.' '.$stud_del->last_name);
    }
    else{
      $user_name = 'Guest';
    }
      ...
      script.addEventListener("load", function (event) {
        ...
        const config = {
          ...
          recording: {
            ...
            awsDirPath: "<?php echo base_url('assets/meeting'); ?>", // automatically save recording in this s3 path
          },
          ...
          joinScreen: {
            ...
            title: "Connect with our Decision Member", // Meeting title
