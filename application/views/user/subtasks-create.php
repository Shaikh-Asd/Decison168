                                                ...
                                                <div class="row mb-2 mt-2" style="border-top: 2px solid #eff2f7;padding: 30px;">
                                                    ...
                                                    <div class="col-md-6">
                                                     ...
                                                     <div style=" margin-left: 570px;">
                                                        <input type="checkbox" name="stask_track1" id="stask_track1" class="form-check-input" onclick="return subtaskTrack('1')">
                                                        <label class="control-label" for="stask_track"> Track your subtask</label>
                                                        <input type="hidden" name="strack_value_get1" id="strack_value_get1" value="true" >
                                                    </div>
                                                    <div class="col-md-5">
                                                    ...
                                                    <div class="mb-3 col-md-6"  id="staskTrack1" style="display:none;">
