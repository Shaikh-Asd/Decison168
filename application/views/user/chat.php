                                    ...
                                    <div class="py-4 border-bottom">
                                        <div class="media">
                                            <div class="align-self-center me-3">
                                                <img src="<?php echo base_url();?>assets/images/users/avatar-1.jpg" class="avatar-xs rounded-circle" alt="">
                                            </div>
                                                        ...
                                                        <li class="active">
                                                            <a href="#">
                                                                <div class="media">
                                                                    ...
                                                                    <div class="align-self-center me-3">
                                                                        <img src="<?php echo base_url();?>assets/images/users/avatar-2.jpg" class="rounded-circle avatar-xs" alt="">
                                                                    </div>
                                                        ...
                                                        <li>
                                                            <a href="#">
                                                                <div class="media">
                                                                    ...
                                                                    <div class="align-self-center me-3">
                                                                        <img src="<?php echo base_url();?>assets/images/users/avatar-3.jpg" class="rounded-circle avatar-xs" alt="">
                                                                    </div>
                                                                    <div class="media-body overflow-hidden">
                                                        ...
                                                        <li>
                                                            <a href="#">
                                                                <div class="media">
                                                                    ...
                                                                    <div class="align-self-center me-3">
                                                                        <img src="<?php echo base_url();?>assets/images/users/avatar-4.jpg" class="rounded-circle avatar-xs" alt="">
                                                                    </div>
                                                                    <div class="media-body overflow-hidden">
                                                        ...
                                                        <li>
                                                            <a href="#">
                                                                <div class="media">
                                                                    ...
                                                                    <div class="align-self-center me-3">
                                                                        <img src="<?php echo base_url();?>assets/images/users/avatar-6.jpg" class="rounded-circle avatar-xs" alt="">
                                                                    </div>
                                                                    <div class="media-body overflow-hidden">
