...
{
?>
                                                            <a href="javascript:void(0)" onclick="return direct_remove_manager('<?php echo $pdetail->pid;?>','<?php echo $pmanager_det->first_name;?>','<?php echo $pmanager_det->last_name;?>');" class="pt-2 pro_manager_icon" title="Remove as Manager"><i class="bx bx-user-x text-d h3 m-1"></i></a>
                                                            <img class="manager_loader2" style="display: none;" src="<?php echo base_url()?>assets/images/loading.gif">
<?php
}
?>
                                                        </th>
