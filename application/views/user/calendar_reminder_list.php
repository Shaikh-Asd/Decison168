...
<head>
        ...
        <meta charset="utf-8" />
<title>Calendar Reminder List</title>
...
<div id="refresh_tasklist_status_change">
    ...
    <div class="col-lg-12">
        <div class="card" style="margin-bottom: 0px;">
            ...
            <div class="row mb-2">
                <div class="col-lg-2">
                    <div class="text-center" style="font-weight: 900;">Reminder</div>
                </div>
                <div class="col-lg-2">
...
<?php
if($getAll_NextReminders)
{
    foreach($getAll_NextReminders as $atl)
    {
?>
...
if($getAll_PrevReminders)
{
    foreach($getAll_PrevReminders as $atl)
    {
?>
<div class="row mb-2 search-list parent_task all-data" data-searchid="<?php echo $atl->event_start_date;?>" data-end-searchid="<?php echo $atl->event_end_date;?>">   
    <div class="col-lg-12">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body" style="padding: 0.5rem 1rem 0rem 1rem !important;">
                ...
                <input type="radio" value="reminder" name="created_type" id="created_type_reminder" checked>
                <li class="nav-item">
            ...
            <div class="tab-content" style="padding: 1rem 1rem 0rem 1rem;">
                ...
                <div class="row mb-3" id="add_note_div" style="display: none;">
                    <div class="col-md-12">
                        <div class="form-group">
                            <div class="input-group">
