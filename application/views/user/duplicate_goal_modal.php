...
<script>
    // FOR  Duplicate GOAL FORM ----------------------------------------
  $('#duplicate_goal_form').on('submit',function(event){
    //debugger;
    event.preventDefault(); // Stop page from refreshing
    $('#duplicate_goal_button').hide();
    $('#loader2').css('visibility','visible');
   var formData = new FormData(this); 
    $.ajax({
         url:base_url+'front/duplicate_goal',
         type:"POST",
         data:formData,
         contentType:false,
         processData:false,
