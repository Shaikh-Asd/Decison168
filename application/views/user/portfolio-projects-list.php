                        ...
                        <div class="btn-group me-1 mt-2">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item" href="javascript: void(0);"><input class="form-check-input" name="filter_proj2" type="radio" id="created_project2" onclick="return project_filter2();">
                                       <label class="form-check-label">Created Projects</label></a>
                                <a class="dropdown-item" href="javascript: void(0);"><input class="form-check-input" name="filter_proj2" type="radio" id="accepted_project2" onclick="return project_filter2();">
                                       <label class="form-check-label">Accepted Projects</label></a>
                                            ...
                                            <tbody>
                                                <?php
                                                    if($plist)
                                                    {
                                                        ...
                                                        {
                                                            ?>
                                                            <tr class="<?php if($p->gid == 0){ echo "regular_proj";} else { echo "goal_proj";}?>">
                                                                <td>
                                                                    <div class="row">
                                                                        <div class="col-2">
                                                                    <?php
                                            ...
                                            <tbody>
                                                <?php
                                                    if($accepted_plist)
                                                    {
                                                        ...
                                                        {
                                                            ?>
                                                            <tr class="<?php if($ap->gid == 0){ echo "regular_proj";} else { echo "goal_proj";}?>">
                                                                <td>
                                                                    <div class="row">
                                                                        <div class="col-2">
                                                                    <?php
                                            ...
                                            <tbody>
                                                <?php
                                                    if($pending_plist)
                                                    {
                                                        ...
                                                        {
                                                            ?>
                                                            <tr class="<?php if($pp->gid == 0){ echo "regular_proj";} else { echo "goal_proj";}?>">
                                                                <td>
                                                                    <div class="row">
                                                                        <div class="col-2">
                                                                    <?php
                                        ...
                                        { 
                                            ...
                                            echo strtoupper($profile_name);
                                                                    ...
                                                                    ?>
                                                                        ...
                                                                        <div class="col-10">
                                                                    <h5 class="font-size-14"><a href="javascript: void(0);" onclick="return ProjectOverviewRequestModal(<?php echo $pp->pid;?>)" class="nameLink" title="Open Project">
                                                                        <?php
                                                                                echo $pp->pname;
                                                                        ?>  
                                                                        </a>
                                            ...
                                            <tbody>
                                                <?php
                                                    if($readmore_plist)
                                                    {
                                                        ...
                                                        {
                                                            ?>
                                                            <tr class="<?php if($rp->gid == 0){ echo "regular_proj";} else { echo "goal_proj";}?>">
                                                                <td>
                                                                    <div class="row">
                                                                        <div class="col-2">
                                                                    <?php
                                        ...
                                        { 
                                            ...
                                            echo strtoupper($profile_name);
                                                                    ...
                                                                    <h5 class="font-size-14">
                                                                        <a href="javascript: void(0);" onclick="return ProjectOverviewRequestModal(<?php echo $rp->pid;?>)" class="nameLink" title="Open Project">
                                                                        <?php
                                                                                echo $rp->pname;
                                                                        ?>  
                                                                        </a>
                                ...
                                if($plist)
                                    {
                                        foreach($plist as $p)
                                            {
                            ?>
    <div class="col-md-6 col-xs-12 col-lg-3 search-cards <?php if($p->gid == 0){ echo "regular_proj";} else { echo "goal_proj";}?>">
                                ...
                                if($accepted_plist)
                                    {
                                        foreach($accepted_plist as $ap)
                                            {
                            ?>
    <div class="col-md-6 col-xs-12 col-lg-3 search-cards <?php if($ap->gid == 0){ echo "regular_proj";} else { echo "goal_proj";}?>">
                                ...
                                if($pending_plist)
                                    {
                                        foreach($pending_plist as $pp)
                                            {
                            ?>
    <div class="col-md-6 col-xs-12 col-lg-3 search-cards <?php if($pp->gid == 0){ echo "regular_proj";} else { echo "goal_proj";}?>">
    <section ng-repeat="new_card in new_cards" class="new_card theme-orange" data-color="#52A43A">
          <section class="new_card__part new_card__part-2">
            <div class="new_card__part__side m--back">
              <div class="new_card__part__inner new_card__face">
                ...
                <div class="new_card__face__from-to">
                  <p class="ng-binding">
                    <a href="javascript: void(0);" onclick="return ProjectOverviewRequestModal(<?php echo $pp->pid;?>)" class="nameLink" data-bs-toggle="popover" data-bs-placement="left" data-bs-trigger="hover" data-bs-content="<?php echo $pp->pname;?>">
                        <?php echo $pp->pname;?>
                     </a></p>
                  <p class="ng-binding"><?php
                                                        if(!empty($pp->pdes))
                                ...
                                if($readmore_plist)
                                    {
                                        foreach($readmore_plist as $rp)
                                            {
                            ?>
    <div class="col-md-6 col-xs-12 col-lg-3 search-cards <?php if($rp->gid == 0){ echo "regular_proj";} else { echo "goal_proj";}?>">
    <section ng-repeat="new_card in new_cards" class="new_card theme-orange" data-color="#52A43A">
          <section class="new_card__part new_card__part-2">
            <div class="new_card__part__side m--back">
              <div class="new_card__part__inner new_card__face">
                ...
                <div class="new_card__face__from-to">
                  <p class="ng-binding">
                    <a href="javascript: void(0);" onclick="return ProjectOverviewRequestModal(<?php echo $rp->pid;?>)" class="nameLink" data-bs-toggle="popover" data-bs-placement="left" data-bs-trigger="hover" data-bs-content="<?php echo $rp->pname;?>">
                        <?php echo $rp->pname;?>
                     </a></p>
                  <p class="ng-binding"><?php
                                                        if(!empty($rp->pdes))
