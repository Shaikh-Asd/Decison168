            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="topnav-menu-content">
                    ...
                    <ul class="navbar-nav ms-auto" id="topnav-menu" >
                        <li class="nav-item">
                            <a class="nav-link text-white" href="<?php echo base_url(); ?>">Back to Dashboard</a>
                        </li>
                    ...
                    <div class="d-flex">
                        <div class="dropdown d-inline-block">
                            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="d-none d-xl-inline-block ms-1 text-white">Call Bookings</span>
                                <i class="mdi mdi-chevron-down d-none d-xl-inline-block text-white"></i>
                            </button>
                            <div class="dropdown-menu dropdown-menu-end">
                                <a class="dropdown-item" href="<?php echo base_url('user-all-calls');?>"><span>All Calls</span></a>    
                                <?php
                                ...
                                if($user_role_del->expert == 1 && $user_role_del->expert_approve == 1 && $user_role_del->expert_status == 'active'){
                                    ?>
                                    <a class="dropdown-item" href="<?php echo base_url('all-calls');?>"><span>Calls for Decision Maker</span></a>
                                    <?php
                                }
                                ?>
                            </div>
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="blog-box mb-4 mb-xl-0">
                                    ...
                                    <div class="mt-4 text-muted">
                                        ...
                                        <div>
                                            <a href="javascript:void(0);" onclick="expertProfileModal(<?php echo $dm->reg_id; ?>);">Book Now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
