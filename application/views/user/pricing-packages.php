        ...
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    if($getMyPack)
                    {
                        if(empty($getMyPack->used_corporate_id))
                        {
                                            ...
                                            <div class="py-4">
                                                <h2><sup><small>$</small></sup> <?php echo $my_package_price->pack_price;?>/ <span class="font-size-13">
                                                    ...
                                                    if(is_numeric($my_package_price->pack_validity))
                                                    {
                                                       ...
                                                       elseif($my_package_price->pack_validity == '90')
                                                       {
                                                            echo "3 Months";
                                                       }
                                                       elseif($my_package_price->pack_validity == '180')
                                                       {
                                                            echo "6 Months";
                                                       }
                                                       elseif($my_package_price->pack_validity == '270')
                                                       {
                                                            echo "9 Months";
                                                       }
                                            ...
                                            <div class="py-4">
                                                ...
                                                <h2><sup><small>$</small></sup> <?php echo $pk->pack_price;?>/ <span class="font-size-13">
                                                    ...
                                                    if(is_numeric($pk->pack_validity))
                                                    {
                                                       ...
                                                       elseif($pk->pack_validity == '90')
                                                       {
                                                            echo "3 Months";
                                                       }
                                                       elseif($pk->pack_validity == '180')
                                                       {
                                                            echo "6 Months";
                                                       }
                                                       elseif($pk->pack_validity == '270')
                                                       {
                                                            echo "9 Months";
                                                       }
                                        ...
                                        <div class="card-body p-4">
                                            ...
                                            <div class="text-center plan-btn">
                                                ...
                                                if($getMyPack)
                                                {
                                                    ...
                                                    {
                                                    ?>
                                                    <a href="javascript: void(0);" class="btn bg-d btn-sm waves-effect waves-light text-white">Contact Your Company</a>
                                                    <?php
                                                    }
                                                    else
                                                    {
