                        ...
                        <div class="w-100">
                            ...
                            <div class="d-flex flex-column h-100">
                                <div class="mb-4 md-5" style="padding: 0 20%;">
                                    <a href="<?php echo base_url('company');?>" class="d-block auth-logo">
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <div class="form-group">
                                          <div class="input-group mb-3">
                                            <input type="text" name="login_username" id="login_username" value="<?php if(isset($_COOKIE["d168_comp_username"])) { echo $_COOKIE["d168_comp_username"]; } ?>" class="form-control pl-15" placeholder="Username" required="">
                                          </div>
                                          <span id="login_usernameErr" class="text-danger"></span>
                                        </div>
                                        <div class="form-group">
                                          <div class="input-group mb-3">
                                            <input type="password" name="login_password" id="login_password" value="<?php if(isset($_COOKIE["d168_comp_password"])) { echo $_COOKIE["d168_comp_password"]; } ?>" class="form-control pl-15 password-pl" placeholder="Password" required="">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                            <input class="form-check-input" type="checkbox" id="remember-check" name="basic_checkbox_1" <?php if(isset($_COOKIE["d168_comp_password"])) { ?> checked <?php } ?> >
                                            ...
                                            <div class="fog-pwd text-right">
                                              <a href="<?php echo base_url('company/reset-password');?>" class="hover-warning" style="font-size: 11px"><i class="ion ion-locked"></i> Forgot password?</a>
                                              </div>                                                
                                            </div>
                                        </div>
                                        </div>
                                ...
                                <div class="mt-5 md-5 text-center text-white">
