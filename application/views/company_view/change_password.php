                                        ...
                                        <form method="POST" name="cp_form" id="cp_form" class="login_form" autocomplete="off">
                                            <div class="form-group">
                                                <div class="input-group mb-3">
                                                    <input type="email" name="username" id="username" value="<?php echo $comp_del->cc_username;?>" readonly="" class="form-control pl-15" placeholder="Company Username" required="">
                                                </div>
                                            ...
                                            <input type="hidden" name="cc_id" id="cc_id" value="<?php echo $comp_del->cc_id;?>">
                                            <div class="text-end">
