    ...
    ChartJs.prototype.respChart = function(selector, type, data, options) {
        ...
        ChartJs.prototype.init = function() {
            ...
            function taskChart2() {
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        var myLine = new Chart(document.getElementById("lineChart").getContext("2d"), {
                            data: lineChart,
                            type: "line",
                            options: lineOpts
                        });
            ...
            function subtaskChart() {
                $.ajax({
                    url: base_url + 'front/subtask_todo',
                    type: 'post',
                    data: {
                        portfolio_id: portfolio_id
                    },
            ...
            function subtaskChart2() {
                $.ajax({
                    url: base_url + 'front/all_subtask',
                    type: 'post',
                    data: {
                        portfolio_id: portfolio_id
                    },
                    success: function(data) {
                        ...
                        var subtsk_prog = data.subtsk_prog;
                        var subtsk_rev = data.subtsk_rev;
                        var subtsk_done = data.subtsk_done;
                        //in_progress
                        var cnt_subprog = subtsk_prog.length;
                        $('#subtask_prog').html(cnt_subprog);
                        var result_subpen = subtsk_prog.reduce((r, {
                            stdue_date
                        }) => {
                            var key = stdue_date.slice(0, 7);
                            r[key] = (r[key] || 0) + 1;
                        ...
                        //review
                        var cnt_subrev = subtsk_rev.length;
                        $('#subtask_rev').html(cnt_subrev);
                        var result_subrev = subtsk_rev.reduce((r, {
                            stdue_date
                        }) => {
                            var key = stdue_date.slice(0, 7);
                            r[key] = (r[key] || 0) + 1;
                        ...
                        //done
                        var cnt_subdone = subtsk_done.length;
                        $('#subtask_done').html(cnt_subdone);
                        var result_subdone = subtsk_done.reduce((r, {
                            stdue_date
                        }) => {
                            var key = stdue_date.slice(0, 7);
                            r[key] = (r[key] || 0) + 1;
            ...
            setTimeout(function() {
                ...
                function projectChart() {
                    $.ajax({
                        url: base_url + 'front/all_project',
                        type: 'post',
                        data: {
                            portfolio_id: portfolio_id,
            ...
            var option = null,
                option = {
                    ...
                    legend: {
                        ...
                        orient: 'horizontal', // move the legend to the bottom
                        x: 'center', // center the legend horizontally
                        y: 'bottom', // position the legend at the bottom of the chart
...
function departmentChart() {
    $.ajax({
        url: base_url + 'front/all_department',
        type: 'post',
        data: {
            portfolio_id: portfolio_id,
...
function contentChart() {
    ...
    if (content_id) {
        $.ajax({
            url: base_url + 'front/all_content',
            type: 'post',
            data: {
                portfolio_id: portfolio_id,
            ...
            success: function(data) {
                ...
                var social1 = data.social1;
                var social2 = data.social2;
                var social3 = data.social3;
                var social4 = data.social4;
                var social5 = data.social5;
                var social6 = data.social6;
                var social7 = data.social7;
                var social8 = data.social8;
                var social9 = data.social9;
                ...
                if (data == '-1') {
                    ...
                    var theme = {
                        ...
                        series: {
                            colors: [
                                '#f46a6a', '#34c38f', '#556ee6', '#ffc107', '#07ff40', '#d907ff', '#009688', '#8b606b', '#868b60', '#071013', '#3e5913', '#2196f3'
                            ]
                        }
                    };
                    // For apply theme
    ...
    var options_individual_member = {
        ...
        dataLabels: {
            ...
            formatter: function(value, context) {
                return 'Total Sales: ' + context.options_individual_member.data.datasets[0].data.reduce((a, b) => a + b, 0);
            }
        },
        stroke: {
            show: !0,
...
// PDf functions start
async function TeamReport(portfolio_id, element5, daterangestart, daterangeend) {
    $.ajax({
        url: base_url + 'front/all_rangemember',
        type: 'post',
        data: {
            portfolio_id: portfolio_id,
            user_id: element5,
            teamstart: daterangestart,
            teamend: daterangeend
        },
        success: function(data) {
            ...
            var options_individual_members = {
                chart: {
                    height: 350,
                    type: "bar",
                    toolbar: {
            ...
            var chartElements = document.getElementById('view_team_chart');

            var cchart = new ApexCharts(chartElements, options_individual_members);
            cchart.render().then(() => {




                    var childIDs = $("#view_team_chart").children().map(function() {
                        return this.id;
                    }).get();
                    // Member
                        ...
                        return new Promise((resolve) => {
                            ...
                            setTimeout(() => {
                                ...
                                html2canvas(tooltipteam).then(canvas => {
                                    ...
                                    myArray.push('Team Performance');
                                    selectedChartCat.push(mem_name);
...
async function departmentReport(portfolio_id, element4, daterangestart, daterangeend) {
    $.ajax({
        url: base_url + 'front/all_rangedepartment',
        type: 'post',
        data: {
            portfolio_id: portfolio_id,
        ...
        success: function(data) {
            ...
            var dep_project = data.dep_rangepro;
            var dep_content = data.dep_rangecnt;
            var dep_task = data.dep_rangetask;
            var dep_goal = data.dep_rangegoal;
            var dep_name = data.dep_name;
            ...
            // var chartContainer = document.querySelector("#view_dept_chart");
            // chartContainer.insertAdjacentHTML('beforebegin', '<div class="removechrt">This is some HTML content</div>');
            var chart_department = new ApexCharts(document.querySelector('#view_dept_chart'), {
                chart: {
                    height: 350,
                    type: "line",
                    stacked: !1,
                ...
                tooltip: {
                    ...
                    //   return '<div style="background-color: #fff; border: 1px solid #ddd; padding: 10px;"><strong>Test something</strong><br> units sold</div>';
                    // }
                },
                grid: {
                    borderColor: "#f1f1f1"
            ...
            var chartElements = document.getElementById('view_dept_chart');

            //var chart_department = new ApexCharts(chartElements, options_individual_members);
                    ...
                    return new Promise((resolve) => {
                        ...
                        setTimeout(() => {
                            ...
                            html2canvas(tooltipteam).then(canvas => {
                                ...
                                selectedChartCat.push(dep_name);
...
async function contentReport(portfolio_id, element3, daterangestart, daterangeend) {
    $.ajax({
        url: base_url + 'front/all_rangecontent',
        type: 'post',
        data: {
            portfolio_id: portfolio_id,
            content_id: element3,
        ...
        success: function(data) {
            ...
            if (data == '-1') {
                ...
                var options_content = {
                    ...
                    tooltip: {
                        className: 'tui-area-chart' // set a custom class name for the tooltip container
                    }
                };
                var theme = {
                    chart: {
                    ...
                    return new Promise((resolve) => {
                        ...
                        setTimeout(() => {
                            ...
                            html2canvas(tooltipcontent).then(canvas => {
                                ...
                                selectedChartCat.push(content_name);
...
async function projectReport(portfolio_id, element2, daterangestart, daterangeend) {
    $.ajax({
        url: base_url + 'front/all_rangeproject',
        type: 'post',
        data: {
            portfolio_id: portfolio_id,
            project_id: element2,
...
async function goalReport(portfolio_id, element, daterangestart, daterangeend) {

    $.ajax({
        url: base_url + 'front/all_rangegoal',
        type: 'post',
        data: {
            portfolio_id: portfolio_id,
            goal_id: element,
        ...
        success: function(data) {
            ...
            goal_kpi_viewdata = result_glkpi;
            goal_kpi_viewyear = Object.keys(result_glkpi);
            ...
            goal_project_viewdata = result_glprjt;
            goal_project_viewyear = Object.keys(result_glprjt);
            ...
            goal_content_viewdata = result_glcnt;
            goal_content_viewyear = Object.keys(result_glcnt);
            ...
            goal_task_viewdata = result_gltask;
            goal_task_viewyear = Object.keys(result_gltask);
            if (goal_kpi_viewyear || goal_project_viewyear || goal_content_viewyear || goal_task_viewyear) {
                union_goal_viewyear = goal_kpi_viewyear.concat(goal_project_viewyear, goal_content_viewyear, goal_task_viewyear).filter(function(value, index, self) {
                    return self.indexOf(value) === index;
                });
                union_goal_viewyear.sort();
                if (union_goal_viewyear) {
                    var year_goal_count = union_goal_viewyear.length;
                    if (year_goal_count) {
                        var goal_kpi_viewarray = [];
                        for (var i = 0; i < year_goal_count; i++) {
                            if (goal_kpi_viewyear.includes(union_goal_viewyear[i])) {
                                var y1 = union_goal_viewyear[i];
                                goal_kpi_viewarray.push(goal_kpi_viewdata[y1]);
                            } else {
                                goal_kpi_viewarray.push(0);
                            }
                        }
                        var goal_project_viewarray = [];
                        for (var j = 0; j < year_goal_count; j++) {
                            if (goal_project_viewyear.includes(union_goal_viewyear[j])) {
                                var y2 = union_goal_viewyear[j];
                                goal_project_viewarray.push(goal_project_viewdata[y2]);
                            } else {
                                goal_project_viewarray.push(0);
                            }
                        }

                        var goal_content_viewarray = [];
                        for (var i = 0; i < year_goal_count; i++) {
                            if (goal_content_viewyear.includes(union_goal_viewyear[i])) {
                                var y1 = union_goal_viewyear[i];
                                goal_content_viewarray.push(goal_content_viewdata[y1]);
                            } else {
                                goal_content_viewarray.push(0);
                            }
                        }
                        var goal_task_viewyear = [];
                        for (var j = 0; j < year_goal_count; j++) {
                            if (goal_task_viewyear.includes(union_goal_viewyear[j])) {
                                var y2 = union_goal_viewyear[j];
                                goal_task_viewyear.push(goal_task_viewdata[y2]);
                            } else {
                                goal_task_viewyear.push(0);
                            }
                        }
                    }
                }
            ...
            var options_goal = {
                    ...
                    series: [{
                        name: "KPI's",
                        data: Object.values(goal_kpi_viewarray || {})
                    }, {
                        name: 'Project',
                        data: Object.values(goal_project_viewarray || {})
                    }, {
                        name: 'Content Project',
                        data: Object.values(goal_content_viewarray || {})
                    }, {
                        name: 'Task',
                        data: Object.values(goal_task_viewyear || {})
                    }],
                    title: {
                        // text: "Average High & Low Temperature",
                        align: "left",
                    ...
                    xaxis: {
                        categories: Object.values(union_goal_viewyear),
                    },
                    yaxis: {
                        title: {
                            text: ""
                    ...
                    return new Promise((resolve) => {
                        ...
                        setTimeout(() => {
                            ...
                            html2canvas(tooltipgoal).then(canvas => {
                                ...
                                myArray.push('Goal');
                                selectedChartCat.push(goal_name);
...
function generateData(hide) {
    ...
    $.ajax({
        url: base_url + 'front/checkTemplate',
        type: 'post',
        data: {
            template: template
        },
                    ...
                    for (var i = 0; i < myoldArray.length; i++) {
                        ...
                        if (newStr === 'summary') {
                            ...
                            html2canvas(chartElements).then(donut => {
                                ...
                                // portfolio member        
                                var chartElements1 = document.querySelector('#doughnut');
                                html2canvas(chartElements1).then(doughnut => {
                                    // use the canvas to create a PNG image
                                    document.body.appendChild(doughnut)
                                    const doughnutImage = doughnut.toDataURL('image/png');
                                    dataArray.push(doughnutImage);

                                    myArray.push('Portfolio Member');
                                    selectedChartCat.push(' ');
                                    ...
                                    // var dep_val = dep_val.options[dep_val.selectedIndex].text;
                                    ...
                                    html2canvas(chartElement2).then(dt => {
                                        ...
                                        // Member
                                        var mem_vals = document.getElementById("selected_user");
                                        // var mem_val = mem_val.options[mem_val.selectedIndex].text;

                                        var selectedIndexMem = mem_vals.selectedIndex;
                                        if (selectedIndexMem !== -1) {
                                            var selectedOptionMem = mem_vals.options[selectedIndexMem];
                                            var selectedTextMem = selectedOptionMem.text;
                                            var mem_val = selectedTextMem;
                                        } else {
                                            var mem_val = '';
                                        }
                                        ...
                                        html2canvas(chartElement3).then(mt => {
                                            ...
                                            myArray.push('Team Performance');
                                            selectedChartCat.push(mem_val);


                                            // Goals
                                            var goal_vals = document.getElementById("selected_goal");
                                            // var goal_val = goal_val.options[goal_val.selectedIndex].text;
                                            ...
                                            html2canvas(chartElement4).then(gt => {
                                                ...
                                                // var cnt_val = cnt_val.options[cnt_val.selectedIndex].text;
                                                ...
                                                html2canvas(chartElement5).then(ct => {
                                                    ...
                                                    // var prjt_val = prjt_val.options[prjt_val.selectedIndex].text;
                                ...
                                setTimeout(() => {
                                    ...
                                    if (cnthasSelectedValue) {
                                        ...
                                        sel_cont_array.forEach(async function(element3) {
                                            await contentReport(portfolio_id, element3, daterangestart, daterangeend);
                                        });
                                        setTimeout(function() {
                                            mainReport(daterangestart, daterangeend, hide);
                                        }, 30000);
                        ...
                        if (newStr === 'portfolio_team') {

                            await new Promise(resolve => {
                                setTimeout(() => {
                                    var sel_team = $('#sel_team').val();
                                    var sel_team_array = sel_team;
                                    var memhasSelectedValue = false;
                                    for (var i = 0; i < sel_team_array.length; i++) {
                                        var memselect = sel_team_array[i];
                                        var selectedOptionsmem = memselect;
                                        if (selectedOptionsmem.length > 0) {
                                            memhasSelectedValue = true;
                                            break;
                                        }
                                    }
                                    if (memhasSelectedValue) {
                                        $('#userErr').text('');
                                        sel_team_array.forEach(async function(element4) {
                                            await TeamReport(portfolio_id, element5, daterangestart, daterangeend);
                                        });
                                        setTimeout(function() {
                                            mainReport(daterangestart, daterangeend, hide);
                                        }, 30000);
                                    } else {
                                        $('#userErr').text('No user is selected');
                                        $('#loaderModal').modal('hide');
                                        $('#exampleModal').modal('show');
                                        document.getElementById("download_pdf").disabled = false;
                                        document.getElementById("download_ppt").disabled = false;
                                ...
                                setTimeout(() => {
                                    ...
                                    if (depthasSelectedValue) {
                                        ...
                                        sel_dept_array.forEach(async function(element4) {
                                            await departmentReport(portfolio_id, element4, daterangestart, daterangeend);
                                        });
                                ...
                                setTimeout(() => {
                                    ...
                                    if (hasSelectedValue) {
                                        ...
                                        new_array.forEach(async function(element) {
                                            await goalReport(portfolio_id, element, daterangestart, daterangeend);
                                        });
                                        setTimeout(function() {
                                            mainReport(daterangestart, daterangeend, hide);
                                        }, 30000);
                        ...
                        if (newStr === 'portfolio_pjt') {
                            ...
                            await new Promise(resolve => {
                                setTimeout(() => {
                                    // var parent_prjt = "view_prjt_chart";
                                    // select_projt = 'yes';
                                    ...
                                    for (var i = 0; i < sel_prjt_array.length; i++) {
                                        ...
                                        if (selectedOptionsPrjt.length > 0) {
                                            // At least one option is selected in the select tag
                                    ...
                                    if (hasSelectedValueprjt) {
                                        ...
                                        sel_prjt_array.forEach(async function(element2) {
                                            await projectReport(portfolio_id, element2, daterangestart, daterangeend);
                                        });
...
function mainReport(daterangestart, daterangeend, hide) {
    ...
    $.ajax({
        url: base_url + 'front/generate_report',
        type: 'post',
        data: {
            myArray: myArray,
            selectedChartCat: selectedChartCat,
            stick: dataArray,
            template: template,
        ...
        success: function(data) {
            if (data) {
                if (pdf === hideValue) {
                    window.location = base_url + 'front/pdfRepExport';
                } else if (ppt === hideValue) {
                    window.location = base_url + 'front/generate_ppt';
                }
            }
...
$("input[name='myReport']").click(function() {
    ...
    if (myReport == 'all') {
        $("#port_hide, #mem_hide, #ind_hide, #dept_hide, #goal_hide, #cnt_hide, #prjt_hide, #tsk_hide, #stsk_hide").show();
    } else if (myReport == 'portfolio') {
        $('#port_hide').show();
        $("#mem_hide, #ind_hide, #dept_hide, #goal_hide, #cnt_hide, #prjt_hide, #tsk_hide, #stsk_hide").hide();
    } else if (myReport == 'portfolio_member') {
        $('#mem_hide').show();
        $("#port_hide, #ind_hide, #dept_hide, #goal_hide, #cnt_hide, #prjt_hide, #tsk_hide, #stsk_hide").hide();
    } else if (myReport == 'task') {
        $('#tsk_hide').show();
        $("#port_hide, #mem_hide, #ind_hide, #dept_hide, #goal_hide, #cnt_hide, #prjt_hide, #stsk_hide").hide();
    } else if (myReport == 'subtask') {
        $('#stsk_hide').show();
        $("#port_hide, #mem_hide, #ind_hide, #dept_hide, #goal_hide, #cnt_hide, #prjt_hide, #tsk_hide").hide();
    } else if (myReport == 'content') {
        $('#cnt_hide').show();
        $("#port_hide, #mem_hide, #ind_hide, #dept_hide, #goal_hide,#prjt_hide, #tsk_hide, #stsk_hide").hide();
    } else if (myReport == 'team_performance') {
        $('#ind_hide').show();
        $("#port_hide, #mem_hide, #dept_hide, #goal_hide, #cnt_hide, #prjt_hide, #tsk_hide, #stsk_hide").hide();
    } else if (myReport == 'department') {
        $('#dept_hide').show();
        $("#port_hide, #mem_hide, #ind_hide, #goal_hide, #cnt_hide, #prjt_hide, #tsk_hide, #stsk_hide").hide();
    } else if (myReport == 'goal') {
        $('#goal_hide').show();
        $("#port_hide, #mem_hide, #ind_hide, #dept_hide, #cnt_hide, #prjt_hide, #tsk_hide, #stsk_hide").hide();
    } else if (myReport == 'project') {
        $('#prjt_hide').show();
        $("#port_hide, #mem_hide, #ind_hide, #goal_hide, #dept_hide, #cnt_hide, #tsk_hide, #stsk_hide").hide();
    }
});

//preview modal for report  file
function previewModalFile(id) {
    var id = id;
    // AJAX request
    $.ajax({
        url: base_url + 'front/preview_report_file',
        type: 'post',
        data: {
            id: id
        },
        success: function(data) {
            ...
            $('#previewModalFile_content').html(data);
            // Display Modal
            $('#previewModalFile').modal('show');
        }
    });
}
...
function delete_report(id) {
    ...
    Swal.fire({
        ...
        if (result.value) {
            // AJAX request
            $.ajax({
                url: base_url + 'front/delete_repttmp',
                type: 'post',
                data: {
                    id: id
                },
