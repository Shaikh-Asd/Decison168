        ...
        <script type="text/javascript">
            var steps = [
                ...
                },
                {
                    title: "Sidebar: Archive",
                    id: "tour_archive",
                    content: "<p class='popover-content'>All Archive projects, tasks, subtasks and content of selected portfolio are shown with filter and reopen option. Clicked on reopen then the selected data will reopen and placed to its original position.</p>"
                },
                {
                    title: "Sidebar: File Cabinet",
                    id: "tour_file_cabinet",
