        ...
        if($getPackDetail)
        {
          ...
          else
          {
            ...
            <?php
                                                    ...
                                                    elseif(($pdetail->ptype == "regular") || ($pdetail->ptype == "goal_strategy"))
                                                    {
...
if($getMydetail)
{
    if(DateTime::createFromFormat('Y-m-d H:i:s', $getMydetail->package_expiry) !== false)
    {
      ...
      {
        ?>
        <a href="javascript: void(0);" onclick="return Expire_Package_popup();" class="btn btn-sm btn-d text-white"><i class="mdi mdi-plus"></i> Create Content</a>
        <?php
      }
      else
      {
        ...
        if($getPackDetail3)
        {
          ...
          if($check_type3 == 'true')
          {
            ...
            <form action="<?php echo base_url('content-project-create');?>" method="post" style="display: inline;">
                <input type="hidden" name="regular_pid" value="<?php echo $pid;?>">
                <input type="hidden" name="regular_pname" value="<?php echo $pdetail->pname;?>">
                <input type="hidden" name="regular_pdes" value="<?php echo $pdetail->pdes;?>">
                <input type="hidden" name="regular_pportfolio" value="<?php echo $pdetail->portfolio_id;?>">
                <input type="hidden" name="gdept" value="<?php echo $pdetail->dept_id;?>">
                <?php
                if($pdetail->ptype == "goal_strategy") 
                {
                ?>
                <input type="hidden" name="gid" value="<?php echo $pdetail->gid;?>">
                <input type="hidden" name="sid" value="<?php echo $pdetail->sid;?>">
                ...
                ?>
                <button type="submit" class="btn btn-sm btn-d text-white"><i class="mdi mdi-plus"></i> Create Content</button> 
            </form>
            <?php
            }
            else
            {
              ?>
                <a href="javascript: void(0);" onclick="return limit_Exceeds_popup();" class="btn btn-sm btn-d text-white"><i class="mdi mdi-plus"></i> Create Content</a>
            <?php
            }
          }
          else
        ...
        if($getPackDetail3)
        {
          ...
          else
          {
            ...
            <?php
                                                    ...
                                                    <a class="h3 eye_preview float-end me-1" href="javascript:void(0)" onclick="return file_it_project('<?php echo $pdetail->pid;?>');" style="padding: 0 !important;font-size: 1.2rem;" title="File it"><i class="mdi mdi-folder-multiple-plus-outline"></i></a>
<?php
            ...
            if($getPackDetail3)
            {
              ...
              else
              {
                ...
                <?php
                            ...
                            <!-- end col -->
                            <?php
                            $check_edit_request = $this->Front_model->check_edit_request($pid);
                            if($check_edit_request)
                            {
                        ?>
                            <div class="col-lg-12">                                
                            <div class="card card-body">
                                <h4 class="card-title">Alerts</h4>
                                <p class="card-title">Edit Field Requests</p>
                                <div data-simplebar style="max-height: 200px;"> 
                                    <div class="table-responsive">
                                        <table class="table project-list-table align-middle table-borderless">
                                            <tbody>
                                                <?php
                                                    foreach($check_edit_request as $cer)
                                                    {
                                                ?>
                                                <tr>
                                                    <td width="30%">
                                                        <?php
                                                        if(($cer->r_pname != $pdetail->pname) && (!empty($cer->r_pname)))
                                                        {
                                                        ?>
                                                            <h5 class="text-truncate font-size-14">Project Name</h5>
                                                            <p class="text-muted mb-0"><?php echo $cer->r_pname;?></p>
                                                        <?php
                                                        }
                                                        if(($cer->r_pdes != $pdetail->pdes) && (!empty($cer->r_pdes)))
                                                        {
                                                        ?>
                                                            <h5 class="text-truncate font-size-14">Project Description</h5>
                                                            <p class="text-muted mb-0"><?php echo $cer->r_pdes;?></p>
                                                        <?php
                                                        }
                                                        ?>
                                                    </td>
                                                    <td>
                                                            <h5 class="text-truncate font-size-14">Request From</h5>
                                                            <p class="text-muted mb-0"><?php echo $cer->first_name." ".$cer->last_name; ?></p>
                                                    </td>
                                                    <td>
                                                            <h5 class="text-truncate font-size-14">Requested On</h5>
                                                            <p class="text-muted mb-0"><?php echo $cer->r_date; ?></p>
                                                    </td>
                                                    <td>
                                                        <div class="row">
                                                        <div class="col-6">
                                                                <a href="javascript:void(0)" onclick="return approve_edit_field('<?php echo $cer->id;?>','<?php echo $cer->m_id;?>','<?php echo $cer->pid;?>');" id="add_approve_edit_fieldButton<?php echo $cer->id;?>" class="btn btn-sm btn-d waves-effect waves-light">
                                                                     Approve
                                                                </a>
                                                        </div>    
                                                        <div class="col-6">
                                                               <a href="javascript:void(0)" onclick="return deny_edit_field('<?php echo $cer->id;?>','<?php echo $cer->m_id;?>','<?php echo $cer->pid;?>');" id="add_deny_edit_fieldButton<?php echo $cer->id;?>" class="btn btn-sm bg-d text-white waves-effect waves-light">
                                                                     Deny
                                                                </a>
                                                        </div>
                                                    </div>
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link active" data-bs-toggle="tab" href="#plink_tab" role="tab">
                                                    <h4 class="card-title mb-4"><?php
                                                        if($pdetail->ptype == "content")
                                                        {
                                                            echo "Content Links & Comments";
                                                        }
                                                        elseif($pdetail->ptype == "regular")
                                                        {
                                                            echo "Project Links & Comments"; 
                                                        }
                                                        else
                                                        {
                                                            echo "Links & Comments";
                                                            ...
                                                            if($stlcount > 0){
                                                                for ($i=0; $i<$stlcount; $i++){
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <h5 class="font-size-14 mb-1">
                                                                                <a href="<?php echo $stlink[$i];?>" class="nameLink" title="Open Link" target="_blank"><?php
                                                                                    echo $stlink[$i];
                                                                                ?>
                                                                                </a>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table align-middle table-nowrap" style="margin-bottom: 0rem;">
                                                <tbody>
                                                    ...
                                                    ?>
                                                    <tr>
                                                        <th colspan="3">Project Manager : <a href="javascript:void(0)" onclick="return TeamProfileModal(<?php echo $pdetail->pmanager;?>)" class="text-dark" title="View Profile"><?php echo $pmanager_det->first_name.' '.$pmanager_det->last_name;?></a> <a href="javascript:void(0)" onclick="return direct_remove_manager('<?php echo $pdetail->pid;?>','<?php echo $pmanager_det->first_name;?>','<?php echo $pmanager_det->last_name;?>');" class="pt-2 pro_manager_icon" title="Remove as Manager"><i class="bx bx-user-x text-d h3 m-1"></i></a><img class="manager_loader2" style="display: none;" src="<?php echo base_url()?>assets/images/loading.gif"></th>
                                                    </tr>
                                                    <?php
                                                        }
                                                    } 
    ...
    <div class="card">        
        <div id="scrollbottom" class="chat-conversation p-2">
            <ul class="list-unstyled mb-0 append_new_msg" data-simplebar style="max-height: 400px;">
                <?php 
                $mentionList = $this->Front_model->MentionList($pid);
                //print_r($mentionList);
                if($comments){
                    $comment_date = "";
