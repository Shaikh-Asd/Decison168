    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body" style="padding: 0.5rem 1rem 0rem 1rem !important;">
                ...
                <li class="nav-item">
                    <a class="nav-link active" data-bs-toggle="tab" href="#cevent" role="tab" aria-selected="true" onclick="event_type_event()">
                ...
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="tab" href="#cmeeting" role="tab" aria-selected="false" onclick="event_type_meeting()">
                ...
                <div id="meeting_sec_div2" style="display: none;">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <div class="form-group">
                                <div>
                                    <input class="form-control" name="mfile[]" id="mfile" type="file" multiple="" />
                ...
                <div id="meeting_sec_div_update2">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-10">
                            <div class="form-group">
                                <div>
                                    <input class="form-control" name="mfile[]" id="mfile_up" type="file" multiple="" />
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <div>
                                    <button type="button" class="btn btn-sm btn-d waves-effect waves-light" onclick="return add_mfile_button();" id="add_mfile_but" title="Add Files">
                                     Add
                                    </button>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-sm bg-d text-white waves-effect close-category-drag" data-bs-dismiss="modal">Close</button>
            </div>
            </form>
        </div> <!-- end modal-content-->
    </div> <!-- end modal dialog-->
                ...
                <div class="row mb-3" id="date-time-section-drag-update">
                    <div class="col-md-6">
                        <div class="bootstrap-timepicker">
                            <div class="form-group">
                            <div class="input-group mb-3">
                                <select id="event_start_time_ud" name="event_start_time" class="form-control select2 create_event_start_time" style="width: 86%;">
                                    <?php
                                    if($time_12hrs){
                                        foreach ($time_12hrs as $t12hrs) {
                                            ?>
                    ...
                    <div class="col-md-6">
                        <div class="bootstrap-timepicker">
                            <div class="form-group">
                            <div class="input-group mb-3">
                                <select id="event_end_time_ud" name="event_end_time" class="form-control select2" style="width: 86%;">
                                <?php
                                    if($time_12hrs){
                                        foreach ($time_12hrs as $t12hrs) {
                                            ?>
